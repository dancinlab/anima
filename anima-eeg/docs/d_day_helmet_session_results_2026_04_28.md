...
HONESTY:  REAL_HW_VERIFIED (raw#91)
```
...
**Ledger**: `state/impedance_real_hardware_audit/2026-04-28_20260428T111506Z.jsonl` (raw#77 schema, 16 rows + summary)
...
Expected output (raw#12 frozen criteria):
...
- raw#9 hexa-only / raw#10 honest / raw#12 pre-registered hypothesis / raw#82 darwin-native
...
raw#91 honesty triad: claim = D-day verified; evidence = ledger `2026-04-28_20260428T111506Z.jsonl` + 16 GREEN measurements; limit = soft-tissue impedance varies with adaptation (5-30 min stable window before scalp dehydration / electrode drift).
