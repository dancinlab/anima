<!-- SHARED:WORK_RULES:START -->
  ...
  ═══════════════════════════════════════════════════════════════
    대상 리포 (6개): TECS-L, anima, sedi, CANON, brainwire, papers
  ...
  ★ 망원경 업그레이드 시 필수 절차 (렌즈 추가/수정/삭제 시 예외 없음!) ★
    1. 캘리브레이션: NEXUS-6 테스트 전체 통과 확인 (cd ~/Dev/canon/tools/nexus6 && cargo test)
  ...
  ═══════════════════════════════════════════════════════════════
    리포: https://github.com/dancinlab/nexus6
    위치: ~/Dev/nexus6/
...
```
  ~/Dev/anima/ (git repo: dancinlab/anima)
...
```
  ★ 모든 논문은 papers 리포에 생성! (dancinlab/papers)
    로컬: ~/Dev/papers/anima/
    GitHub: https://github.com/dancinlab/papers
...
계정 리포: [dancinlab/secret](https://github.com/dancinlab/secret) (private)
