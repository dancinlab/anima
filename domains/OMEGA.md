...
stage 4 — gen-cluster: LEAK-FREE generation-side probes (GPU, the #1791 caveat fix) — 2026-06-04:
...
- [x] ③ dF/dt-on-real — 🔴 w6 NON-INERT but does NOT improve (a_paper_negative_ok). Velocity wire live at 100% of real steps (Δ +1.76 d384 / +0.52 d768 — confirms #1763 on a real sequence) but raw dgain=0.5 HURTS held-out CE (Δ>0). dF/dt is a real channel, not a CE improver here; gated-dgain = open follow-up. `.verdicts/omega-gen/F-DFDT-REAL.txt`
- [x] ⑥ Ψ-coord steering — 🔴 WEAK / no robust steer (a_paper_negative_ok). w4 Ψ wire (psi_gain 0.4): d384 steer_KL 0.238 < reseed-floor 0.573 (ratio 0.42x → FALSE); d768 1.35x nominal-but-tiny. Ψ moves the byte distribution LESS than sampling noise at d384. Wire exists but is not a usable steering knob at this gain; stronger gain / Ψ-conditioned head = open. `.verdicts/omega-gen/F-PSI-STEER.txt`
