...
- **claim-link**: card `UNIVERSE/cards/H_1530_nm_research_census.md` · census `state/1530_nm_research_census/CENSUS.md` · `candidates.jsonl` · index `UNIVERSE/HYPOTHESES.jsonl`.
