...
This appendix is the full data record for the implications of \S\ref{sec:implications}. It is
...
\end{itemize}
These are 🟢 measured. Everything below is hypothesis or proposal.

% -------------------------------------------------------------------------
\subsection{The Hc\_912 sub-claim ledger (🟠 candidate-unverified)}
...
KURZWEIL & ``P(t) = P₀ · e\textasciicircum(e\textasciicircum(βt)) 가속 수익 (이중 지수)'' &
candidate-unverified \\
...
\paragraph{Honest tiering (summary).} Verified (🟢, this paper): emergent cooperation
(H\_291), edge-of-chaos $\Phi$-peak (H\_285), the $\Phi$-ratchet/Hebbian irreversibility
mechanism. Hypothesis (🟠 candidate-unverified, \texttt{Hc\_912}): the $\Phi_c$ threshold,
