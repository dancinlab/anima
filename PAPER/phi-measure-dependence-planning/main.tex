...
H\_1012 (robust in $n$, this paper)    & \tierGreen{} DISAGREEMENT-ROBUST-IN-N   & \texttt{.verdicts/1012\_bigphi\_faithful\_larger\_n} \\
...
\bottomrule
\end{tabular}
\caption{The four pre-registered hypotheses behind this paper, each with its
terminal verdict token and the verbatim record path. Every numeric claim in
the body traces to one of these four files.}
\label{tab:siblings}
\end{table}
