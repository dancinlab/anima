# LIFE — 생명·의식 영구 발견 엔진 (도메인 SSOT)

@title: 🧬 LIFE — 생명·의식 영구 발견 엔진 ("멈추지 않는 가설 lane")
@goal: **우주의 생명·의식 법칙이 모두 밝혀질 때까지 멈추지 않는** HEXAD/LIFE 횡단 가설 lane — `/cycle` 로 H_XXX 가설을 verify-driven 영구 진행 (🔵/🟢 promote 누적 + 🔴 closed-negative + cross-link synthesis), 새 H 와 새 축이 끝없이 자란다. **종료 조건 없음 — 도메인은 완료되지 않는다** (진행바 100% 미도달 = 설계).

## hub

| surface | 역할 |
|---|---|
| [`HEXAD/LIFE/README.md`](HEXAD/LIFE/README.md) | 현재 가설 인덱스 SSOT (45 H + 1 lib, 11-domain) |
| [`HEXAD/LIFE/CANDIDATES.md`](HEXAD/LIFE/CANDIDATES.md) | 다음 cycle 후보 백로그 (forward-looking) |
| [`HEXAD/LIFE/AXES.md`](HEXAD/LIFE/AXES.md) | 11-domain 71-axis scope + ~110 H seed brainstorm |
| `HEXAD/LIFE/H_xxx_*.md` | 가설 본체 (10-section 한글 양식) |
| `HEXAD/LIFE/state/` | run artifacts (per-cycle 측정 산출물) |
