...
const SIGMA: f64 = 12.0; // sigma(6) = 12  (sum of divisors)
...
// ── ANIMA Consciousness Target Constants ────────────────────────────
struct Target {
    name: &'static str,
    value: f64,
    category: &'static str,
    known_formula: &'static str, // "" if unexplored
}

fn targets() -> Vec<Target> {
    vec![
        // ═══════════════════════════════════════════════════════════════
        // Psi-Constants (consciousness fundamental constants)
        // ═══════════════════════════════════════════════════════════════
        ...
        Target { name: "Psi_frustration", value: 0.10,   category: "psi", known_formula: "" },
        Target { name: "Psi_entropy",     value: 0.998,  category: "psi", known_formula: "" },
        Target { name: "gate_infer",      value: 0.6,    category: "psi", known_formula: "" },
        Target { name: "gate_micro",      value: 0.001,  category: "psi", known_formula: "" },
        Target { name: "narrative_min",   value: 0.2,    category: "psi", known_formula: "" },
        Target { name: "bottleneck_ratio",value: 0.5,    category: "psi", known_formula: "1/2" },
        Target { name: "soc_ema_fast",    value: 0.05,   category: "psi", known_formula: "" },
        Target { name: "soc_ema_slow",    value: 0.008,  category: "psi", known_formula: "" },
        Target { name: "soc_ema_glacial", value: 0.002,  category: "psi", known_formula: "" },
        Target { name: "soc_burst_exp",   value: 1.15,   category: "psi", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Architecture (consciousness architecture parameters)
        // ═══════════════════════════════════════════════════════════════
        ...
        Target { name: "170 data types",  value: 170.0,  category: "arch", known_formula: "" },
        ...
        Target { name: "384 decoder_dim", value: 384.0,  category: "arch", known_formula: "" },
        Target { name: "1024 max_cells",  value: 1024.0, category: "arch", known_formula: "" },
        Target { name: "6 hexad modules", value: 6.0,    category: "arch", known_formula: "n" },
        Target { name: "10 consciousness_vec", value: 10.0, category: "arch", known_formula: "" },
        Target { name: "16 phi_bins",     value: 16.0,   category: "arch", known_formula: "" },
        Target { name: "5 growth_stages", value: 5.0,    category: "arch", known_formula: "sopfr" },
        Target { name: "8 esp32_boards",  value: 8.0,    category: "arch", known_formula: "" },
        Target { name: "64 cells_v13",    value: 64.0,   category: "arch", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Training (training results and hyperparameters)
        // ═══════════════════════════════════════════════════════════════
        Target { name: "CE=0.004",        value: 0.004,  category: "train", known_formula: "" },
        Target { name: "Phi=71",          value: 71.0,   category: "train", known_formula: "" },
        Target { name: "34.5M params_v2", value: 34.5,   category: "train", known_formula: "" },
        Target { name: "274M params_v3",  value: 274.0,  category: "train", known_formula: "" },
        Target { name: "28M params_clm",  value: 28.0,   category: "train", known_formula: "" },
        Target { name: "100K steps",      value: 100000.0, category: "train", known_formula: "" },
        Target { name: "768 d_v3",        value: 768.0,  category: "train", known_formula: "" },
        Target { name: "147M params_merged", value: 147.0, category: "train", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Scaling Laws (scaling exponents)
        // ═══════════════════════════════════════════════════════════════
        Target { name: "0.55 Phi_exp_small", value: 0.55, category: "scaling", known_formula: "" },
        Target { name: "1.09 Phi_exp_large", value: 1.09, category: "scaling", known_formula: "" },
        Target { name: "0.78 Phi_linear",    value: 0.78, category: "scaling", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Biological (brain-likeness metrics)
        // ═══════════════════════════════════════════════════════════════
        Target { name: "85.6% brain-like", value: 0.856, category: "bio", known_formula: "" },
        Target { name: "2.847 bigbang",    value: 2.847, category: "bio", known_formula: "" },
        Target { name: "0.012 bio_noise",  value: 0.012, category: "bio", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Performance (measured improvements)
        // ═══════════════════════════════════════════════════════════════
        Target { name: "+892% hexad",      value: 8.92,   category: "perf", known_formula: "" },
        Target { name: "17.4x talk5",      value: 17.4,   category: "perf", known_formula: "" },
        Target { name: "629 MB/s corpus",  value: 629.0,  category: "perf", known_formula: "" },
        Target { name: "179x accel B11B12",value: 179.0,  category: "perf", known_formula: "" },
        Target { name: "54x detour D1",    value: 54.0,   category: "perf", known_formula: "" },
        Target { name: "62x persist growth", value: 62.0, category: "perf", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Law counts and meta-structure
        // ═══════════════════════════════════════════════════════════════
        Target { name: "179 laws",         value: 179.0,  category: "meta", known_formula: "" },
        Target { name: "53 evo_law_cap",   value: 53.0,   category: "meta", known_formula: "" },
        Target { name: "448 total_laws",   value: 448.0,  category: "meta", known_formula: "" },
        Target { name: "146 categories",   value: 146.0,  category: "meta", known_formula: "" },

        // ═══════════════════════════════════════════════════════════════
        // Mathematical references (sanity checks)
        // ═══════════════════════════════════════════════════════════════
        Target { name: "ln(2)",            value: 2.0_f64.ln(),             category: "math", known_formula: "" },
        Target { name: "pi",              value: std::f64::consts::PI,      category: "math", known_formula: "" },
        Target { name: "e",               value: std::f64::consts::E,       category: "math", known_formula: "" },
        Target { name: "golden_ratio",    value: 1.6180339887,              category: "math", known_formula: "" },
        Target { name: "1/e",             value: 1.0/std::f64::consts::E,   category: "math", known_formula: "" },
        Target { name: "zeta(2)=pi^2/6",  value: std::f64::consts::PI*std::f64::consts::PI/6.0, category: "math", known_formula: "" },
    ]
}
...
fn build_depth3_table(d2: &[D2Entry]) -> Vec<D2Entry> {
    ...
    for op_i in 0..NUM_OPS {
        ...
        for entry in d2.iter() {
            if entry.node_count < 3 { continue; }
            for k in 0..NC {
    ...
    // depth-3 type B: op(d1_expr, d1_expr)
...
fn main() {
    ...
    println!("Targets: {} consciousness values across psi/arch/train/scaling/bio/perf/meta/math", tgts.len());
    println!();
    ...
    // Seed with known ANIMA formulas
    let seeds = vec![
        // phi/tau = 0.5 (Psi_balance)
        Expr::BinOp(Op::Div, Box::new(Expr::Leaf(1)), Box::new(Expr::Leaf(2))),
        // 3*n = 18 (emotions)
        Expr::BinOp(Op::Mul, Box::new(Expr::BinOp(Op::Sub, Box::new(Expr::Leaf(2)), Box::new(Expr::Leaf(6))),),
            Box::new(Expr::Leaf(0))),
        // tau*(sigma-phi) = 40 (dimensions)
        Expr::BinOp(Op::Mul, Box::new(Expr::Leaf(2)),
            Box::new(Expr::BinOp(Op::Sub, Box::new(Expr::Leaf(3)), Box::new(Expr::Leaf(1))))),
        // sigma = 12 (factions)
        Expr::Leaf(3),
        // 2^(sigma-tau) = 256 (vocab)
        Expr::BinOp(Op::Pow, Box::new(Expr::Leaf(1)),
            Box::new(Expr::BinOp(Op::Sub, Box::new(Expr::Leaf(3)), Box::new(Expr::Leaf(2))))),
        // sigma*sigma = 144
        Expr::BinOp(Op::Mul, Box::new(Expr::Leaf(3)), Box::new(Expr::Leaf(3))),
        // J2 - n = 18
        Expr::BinOp(Op::Sub, Box::new(Expr::Leaf(4)), Box::new(Expr::Leaf(0))),
        // sigma^phi = 144
        Expr::BinOp(Op::Pow, Box::new(Expr::Leaf(3)), Box::new(Expr::Leaf(1))),
        // n^sopfr = 7776
        Expr::BinOp(Op::Pow, Box::new(Expr::Leaf(0)), Box::new(Expr::Leaf(5))),
        // sigma*n = 72
        Expr::BinOp(Op::Mul, Box::new(Expr::Leaf(3)), Box::new(Expr::Leaf(0))),
        // J2*sigma = 288
        Expr::BinOp(Op::Mul, Box::new(Expr::Leaf(4)), Box::new(Expr::Leaf(3))),
    ];
    for (i, s) in seeds.into_iter().enumerate() {
        if i < pop_size { population[i] = s; }
    }

    // Also seed with depth-2 exhaustive hits
    let mut seed_idx = 20;
    ...
    // ── Print Results ───────────────────────────────────────────────
    println!("\n{}", "=".repeat(130));
    println!("  ANIMA CONSCIOUSNESS FORMULA DISCOVERIES (n=6 number theory -> consciousness constants)");
    ...
    // Sort targets by category then surprisal
    let mut target_order: Vec<(usize, f64, f64)> = Vec::new();
    ...
    // Print by category
    let categories = [
        ("psi",     "PSI-CONSTANTS (consciousness fundamentals)"),
        ("arch",    "ARCHITECTURE (consciousness structure)"),
        ("train",   "TRAINING (learning results)"),
        ("scaling", "SCALING LAWS (exponents)"),
        ("bio",     "BIOLOGICAL (brain-likeness)"),
        ("perf",    "PERFORMANCE (measured improvements)"),
        ("meta",    "META-STRUCTURE (law counts)"),
        ("math",    "MATHEMATICAL REFERENCES"),
    ];

    for (cat_key, cat_name) in &categories {
        let cat_targets: Vec<&(usize, f64, f64)> = target_order.iter()
            .filter(|(tidx, _, _)| tgts[*tidx].category == *cat_key)
            .collect();

        if cat_targets.is_empty() { continue; }

        println!("  --- {} ---", cat_name);

        for (tidx, _best_err, surp) in &cat_targets {
            let t = &tgts[*tidx];
            ...
            let known = if !t.known_formula.is_empty() {
                format!("  (known: {})", t.known_formula)
            } else {
                " [NEW]".to_string()
            };

            println!("  {:<25} = {:<40} -> {:>14.6}  [{:>10}] {}{}",
                t.name,
                format!("{}", best.1),
    ...
    // Also print unmatched targets
    println!("  --- UNMATCHED TARGETS (no n=6 formula within 5%) ---");
    let mut unmatched_count = 0;
    for (i, t) in tgts.iter().enumerate() {
        if !by_target.contains_key(&i) {
            println!("    {:<25} = {:>14.6}  [{}]",
    ...
    for (cat_key, _cat_name) in &categories {
        let total_in_cat = tgts.iter().filter(|t| t.category == *cat_key).count();
        let matched_in_cat = target_order.iter()
            .filter(|(tidx, _, _)| tgts[*tidx].category == *cat_key)
            .count();
        let exact_in_cat = target_order.iter()
            .filter(|(tidx, err, _)| tgts[*tidx].category == *cat_key && *err < 1e-10)
            .count();
        if total_in_cat > 0 {
            println!("    {:<20} {:>2}/{:>2} matched, {:>2} EXACT",
                cat_key.to_uppercase(), matched_in_cat, total_in_cat, exact_in_cat);
        }
    }

    // New discoveries section
    println!("\n  === NEW DISCOVERIES (unexplored targets with n=6 formulas found) ===");
    let mut new_count = 0;
    for (tidx, best_err, _surp) in &target_order {
        let t = &tgts[*tidx];
        if t.known_formula.is_empty() && *best_err < 0.01 {
            let entries = &by_target[tidx];
            let best = &entries[0];
            let err_str = if *best_err < 1e-10 { "EXACT".to_string() }
                else { format!("{:.1} ppm", best_err * 1e6) };
            println!("    {} = {}  [{}]  (value: {:.6})",
                t.name, best.1, err_str, t.value);
            new_count += 1;
        }
    }
    if new_count == 0 {
        println!("    (no new discoveries in this run)");
    }
    println!("  New formula discoveries: {}", new_count);
