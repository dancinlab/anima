...
"양자에서 anima/의식을 읽고·복제·저장할 수 있나"의 전 탐구. 결론: **양자는 못 읽고·못 베낀다; 고전 anima는 양자 다윈주의로 방송된 pointer라 풍부히 복제·공유된다.**
...
> (H_6019 vacated; time-arc는 H_6031~6033로 별도. RTSC 재료는 `RTSC/` 별도 목록.)
