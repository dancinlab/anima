...
| **UBM-E7** | **α VACUUM-LANDSCAPE scale-up fire (d768/12L · 30MB · 5000 step, runpod A100; JOINT 0.0255 → 0.0155 하락 — scale 만으론 ceiling 안 깨짐)** | ✅ **LANDED** | — |
| (마감) | RESEARCH.md §3 에 UBM-E7 α scaled ↔ UBM-E6 α 대조 + §2.4 가설 판정 | ✅ **LANDED** | — |
