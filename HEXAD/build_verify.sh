...
#   • always-gated (stale-toolchain-clean): 10 entrypoints + 9 libs.
...
# (10th always-gated entrypoint / 9th lib = HEXAD/CHAT/wiring_verify —
...
# and EXCLUDED from the pass-count denominator. The other 11/9 still gate
...
# ── toolchain selection ─────────────────────────────────────────────────────
# Default toolchain for the 11/9 non-CHAT modules: plain `hexa` (system).
...
CHAT_ENTRYPOINTS=( "HEXAD/D/d.hexa" "HEXAD/integ_test.hexa" "HEXAD/CHAT/anima_chat.hexa" )
