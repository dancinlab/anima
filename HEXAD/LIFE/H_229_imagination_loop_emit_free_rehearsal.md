...
- **smoke**: `HEXAD/LIFE/state/h229_imagination_loop_2026_05_24/run_h229.hexa`
...
- **honest tier**: 🟢 NUMERICAL Φ_proxy (mean inter-cell tension) — true
  IIT 4.0 Φ 아님 (L2 명시).
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 __HEXA_FARR_GAUSS_SEED__=42 hexa run HEXAD/LIFE/state/h229_imagination_loop_2026_05_24/run_h229.hexa`
