...
- **hexa_only**: `HEXAD/LIFE/state/h276_cascade_dynamics_timing_2026_05_25/run_h276.hexa`
...
- **run cmd (verbatim — mac-local, CWD = worktree root)**:
  `HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h276_cascade_dynamics_timing_2026_05_25/run_h276.hexa`
...
- **phi machinery**: `HEXAD/LIFE/lib/phi_helper.hexa` (`phi_with` /
...
- **literature pointer**: Bassler (2002) quorum sensing · Waters & Bassler (2005)
  ...
  본 cycle 미수행).
- **state**: `HEXAD/LIFE/state/h276_cascade_dynamics_timing_2026_05_25/{run_h276.hexa,
  result.json, det.txt}`.
