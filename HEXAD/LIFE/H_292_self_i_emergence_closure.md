...
- **smoke**: `HEXAD/LIFE/state/h292_self_i_emergence_closure_2026_05_26/run_h292.hexa`
...
- **axes seed**: `HEXAD/LIFE/AXES.md` R4 (self/identity) rank-5 `self-i-emergence` — consumed.
