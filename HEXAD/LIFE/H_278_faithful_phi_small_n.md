...
- **smoke**: `HEXAD/LIFE/state/h278_faithful_phi_2026_05_25/run_h278.hexa`
- **Φ primitive (MI)**: `HEXAD/LIFE/lib/phi_helper.hexa` → `c_phi_mi_pair` /
...
- **Φ primitive**: `HEXAD/LIFE/lib/phi_helper.hexa` (`phi_with` / `c_phi_mi_pair`
  → RFC 036 phi_spatial / phi_mi_pair) + `HEXAD/LIFE/lib/phi_native.hexa` (pure-hexa
...
**State output**: `HEXAD/LIFE/state/h278_faithful_phi_2026_05_25/result.json`
**Smoke**: `HEXAD/LIFE/state/h278_faithful_phi_2026_05_25/run_h278.hexa`
