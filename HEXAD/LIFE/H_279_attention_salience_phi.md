...
- **hexa_only**:
  `HEXAD/LIFE/state/h279_attention_salience_phi_2026_05_25/run_h279.hexa`
...
- **run cmd (verbatim)**:
  `X=$HOME/.x __HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h279_attention_salience_phi_2026_05_25/run_h279.hexa`
...
- **AXES**: `HEXAD/LIFE/AXES.md` Round 3 (phenomenology) `attention-salience-Φ`
...
- **state**: `HEXAD/LIFE/state/h279_attention_salience_phi_2026_05_25/{run_h279.hexa,
  result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h279_attention_salience_phi_2026_05_25/result.json
```
