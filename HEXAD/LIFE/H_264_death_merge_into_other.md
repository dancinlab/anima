...
- **hexa_only**: `HEXAD/LIFE/state/h264_death_merge_into_other_2026_05_25/run_h264.hexa`
...
- **run cmd (verbatim, mac-local gate 우회 env-var prefix)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h264_death_merge_into_other_2026_05_25/run_h264.hexa`
...
- **state**: `HEXAD/LIFE/state/h264_death_merge_into_other_2026_05_25/{run_h264.hexa,
  result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h264_death_merge_into_other_2026_05_25/result.json
```
