...
- **hexa_only**: `HEXAD/LIFE/state/h209_eeg_1f_spectrum_2026_05_23/run_h209.hexa`
...
**State output**: `HEXAD/LIFE/state/h209_eeg_1f_spectrum_2026_05_23/{run_h209.hexa, result.json}`

### Cycle #1 Verification (2026-05-23) — 1/f^β × phi_spatial β-sweep

`HEXAD/LIFE/state/h209_eeg_1f_spectrum_2026_05_23/run_h209.hexa`
