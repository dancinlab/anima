...
- **hexa_only**: `HEXAD/LIFE/state/h271_seed_injection_2026_05_25/run_h271.hexa`
...
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h271_seed_injection_2026_05_25/run_h271.hexa`
...
- **literature pointer**: external inoculation / spore germination (dormancy →
  ...
  mapping 본 cycle 미수행).
- **state**: `HEXAD/LIFE/state/h271_seed_injection_2026_05_25/{run_h271.hexa,
  result.json}`.
