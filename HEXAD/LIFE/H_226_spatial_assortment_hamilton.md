...
- hexa_only: true — `HEXAD/LIFE/state/h226_spatial_assortment_hamilton_2026_05_24/run_h226.hexa`
...
- run:
  ```
  hexa parse HEXAD/LIFE/state/h226_spatial_assortment_hamilton_2026_05_24/run_h226.hexa
  HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h226_spatial_assortment_hamilton_2026_05_24/run_h226.hexa
  ```
...
- **HEXAD/LIFE/H_210 Ethic-Emergence**: 본 cycle 의 *직접 follow-up*.
...
- **HEXAD/LIFE/H_054 Symbiogenesis**: endosymbiosis = mitosis MERGE; 본 H 는
  그 MERGE 가 *발화 조건* (spatial proximity required) 의 evolutionary 직접
  사이드.
- **HEXAD/LIFE/H_018 Genesis**: spontaneous genesis 의 substrate-condition
...
`HEXAD/LIFE/state/h226_spatial_assortment_hamilton_2026_05_24/run_h226.hexa`
...
VERDICT: SUPPORTED  (4/5 falsifiers PASS)
  result.json -> HEXAD/LIFE/state/h226_spatial_assortment_hamilton_2026_05_24/result.json
================================================================
```
