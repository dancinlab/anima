...
- **toolchain**: H_003 H3.4 노트 (`HEXAD/LIFE/H_003_life_origin_question.md` §H3.4) —
...
**Run**: 2026-05-23, mac-local, `HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h202_selfref_phi_2026_05_23/run_h202.hexa`, $0 cost, deterministic (re-run byte-identical).
