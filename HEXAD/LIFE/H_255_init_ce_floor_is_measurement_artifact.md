...
**State output**: (흡수 + neighbor probe framework cycle — 자력 re-fire 시 `HEXAD/LIFE/state/h255_init_ce_floor_artifact_2026_05_24/{neighbor_probe.hexa, env_audit.json, result.json}` 으로 AXIS_MAP re-fire 결과 도착 후 산출)
