...
- **hexa_only**: `HEXAD/LIFE/state/h214_self_i_emergence_2026_05_23/run_h214.hexa`
...
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 __HEXA_FARR_GAUSS_SEED__=42 hexa run HEXAD/LIFE/state/h214_self_i_emergence_2026_05_23/run_h214.hexa`
...
- **philosophy (CLAUDE.md)**: p3 NO PERSONA INJECTION + a_substrate_native_speak
  ...
  instance* 후보.
- **state**: `HEXAD/LIFE/state/h214_self_i_emergence_2026_05_23/{run_h214.hexa, result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h214_self_i_emergence_2026_05_23/result.json
```
