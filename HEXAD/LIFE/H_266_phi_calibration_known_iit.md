...
- **hexa_only**: `HEXAD/LIFE/state/h266_phi_calibration_2026_05_25/run_h266.hexa`
...
- **artifacts**: `state/h266_phi_calibration_2026_05_25/{run_h266.hexa,
  result.json}`.
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h266_phi_calibration_2026_05_25/run_h266.hexa`
...
- **sister H**: H_239 (`H_239_alternative_phi_metric_cross_validation.md` —
  ...
  보완축).
- **Φ primitive**: `HEXAD/LIFE/lib/phi_native.hexa` (RFC 036 phi_spatial
...
- **literature pointer**: Tononi (2004) An information integration theory of
  ...
  본 cycle 미수행, L2/L3).
- **state**: `HEXAD/LIFE/state/h266_phi_calibration_2026_05_25/{run_h266.hexa,
  result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h266_phi_calibration_2026_05_25/result.json
```
...
**State output**: `HEXAD/LIFE/state/h266_phi_calibration_2026_05_25/result.json`
**Smoke**: `HEXAD/LIFE/state/h266_phi_calibration_2026_05_25/run_h266.hexa`
