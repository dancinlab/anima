...
- **hexa_only**: true — `HEXAD/LIFE/state/h012_autopoietic_2026_05_23/run_closure.hexa` (NO .py/.sh)
...
- **state**: `HEXAD/LIFE/state/h012_autopoietic_2026_05_23/{run_closure.hexa, result.json}`

## Verdict

raw#12 pre-register-frozen smoke — operational-closure minimal instance, $0 mac local hexa-only deterministic. `hexa run HEXAD/LIFE/state/h012_autopoietic_2026_05_23/run_closure.hexa` stdout VERBATIM:
...
=== H_012 VERDICT: PASS ===
  ledger -> HEXAD/LIFE/state/h012_autopoietic_2026_05_23/result.json
```
...
**State output**: `HEXAD/LIFE/state/h012_autopoietic_2026_05_23/result.json`
**Smoke**: `HEXAD/LIFE/state/h012_autopoietic_2026_05_23/run_closure.hexa` (hexa-only, $0 mac local)
