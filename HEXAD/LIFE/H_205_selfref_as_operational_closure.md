...
- **definitional / mapping bridge**: HEXAD/LIFE 의 대부분 가설은 *empirical
...
- **hexa_only**: `HEXAD/LIFE/state/h205_selfref_as_closure_2026_05_23/run_h205.hexa` (mitosis_hook_lib `cell_pool_init` + `mitosis_forward_tail` 직접 step).
...
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 __HEXA_FARR_GAUSS_SEED__=42 hexa run HEXAD/LIFE/state/h205_selfref_as_closure_2026_05_23/run_h205.hexa`
...
- **state**: `HEXAD/LIFE/state/h205_selfref_as_closure_2026_05_23/{run_h205.hexa, result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h205_selfref_as_closure_2026_05_23/result.json
```
