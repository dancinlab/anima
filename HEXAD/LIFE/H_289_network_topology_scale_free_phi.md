...
- **smoke**: `HEXAD/LIFE/state/h289_network_topology_scale_free_phi_2026_05_26/run_h289.hexa`
...
- **axes seed**: `HEXAD/LIFE/AXES.md` R5 (information) `network-topology-scale-free` — consumed.
