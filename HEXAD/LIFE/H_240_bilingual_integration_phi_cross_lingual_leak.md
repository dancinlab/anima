...
- **smoke**: `HEXAD/LIFE/state/h239_bilingual_integration_phi_2026_05_24/run_h239.hexa`
...
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h239_bilingual_integration_phi_2026_05_24/run_h239.hexa`
