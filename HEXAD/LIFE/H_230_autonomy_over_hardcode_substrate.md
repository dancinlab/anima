...
- **hexa_only**: `HEXAD/LIFE/state/h230_autonomy_over_hardcode_2026_05_24/run_h230.hexa` (mitosis_hook_lib `cell_pool_init` + `mitosis_forward_tail` 직접 step).
...
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 __HEXA_FARR_GAUSS_SEED__=42 hexa run HEXAD/LIFE/state/h230_autonomy_over_hardcode_2026_05_24/run_h230.hexa`
...
- **state**: `HEXAD/LIFE/state/h230_autonomy_over_hardcode_2026_05_24/{run_h230.hexa, result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h230_autonomy_over_hardcode_2026_05_24/result.json
```
