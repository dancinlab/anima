# HEXAD/LIFE/AXES.md — 11-domain SSOT scope + 15-round hypothesis seed catalog

본 파일 = HEXAD/LIFE/ 의 **scope 확장 catalog**. README.md 의 7-domain table 은
...
2. `HEXAD/LIFE/state/<h_id>_<slug>_DATE/` smoke (hexa-only, deterministic, $0 mac local)
