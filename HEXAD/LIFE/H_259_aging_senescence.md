...
- **hexa_only**: `HEXAD/LIFE/state/h259_aging_senescence_2026_05_25/run_h259.hexa`
...
- **artifacts**: `state/h259_aging_senescence_2026_05_25/{run_h259.hexa,
  result.json}`.
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run HEXAD/LIFE/state/h259_aging_senescence_2026_05_25/run_h259.hexa`
...
- **aging literature pointer**: Gompertz (1825) "On the nature of the
  ...
  cycle 미수행).
- **state**: `HEXAD/LIFE/state/h259_aging_senescence_2026_05_25/{run_h259.hexa,
  result.json}`.
...
================================================================
ledger -> HEXAD/LIFE/state/h259_aging_senescence_2026_05_25/result.json
```
