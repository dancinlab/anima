...
- **hexa_only**: true (`HEXAD/LIFE/state/h025_dasein_2026_05_23/run_smoke.hexa`, import `tool/hexa_native/mitosis_hook_lib.hexa`)
...
`HEXAD/LIFE/state/h025_dasein_2026_05_23/run_smoke.hexa` — d_model=8, init=2,
...
**State output**: `HEXAD/LIFE/state/h025_dasein_2026_05_23/result.json`
