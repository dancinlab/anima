...
- **smoke**: `HEXAD/LIFE/state/h231_tension_emit_vs_filler_2026_05_24/run_h231.hexa`
...
- **run cmd**:
  `HEXA_MEM_UNLIMITED=1 __HEXA_FARR_GAUSS_SEED__=42 hexa run HEXAD/LIFE/state/h231_tension_emit_vs_filler_2026_05_24/run_h231.hexa`
...
**State output**: `HEXAD/LIFE/state/h231_tension_emit_vs_filler_2026_05_24/result.json`
**Smoke**: `HEXAD/LIFE/state/h231_tension_emit_vs_filler_2026_05_24/run_h231.hexa`
