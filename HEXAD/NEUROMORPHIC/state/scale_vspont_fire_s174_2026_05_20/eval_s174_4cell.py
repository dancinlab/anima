...
ALL inference-only on S167-A ckpt (ckpt_s174_scale_vspont.pt, sha to be checked).
...
S167A_DIR = "/Users/ghost/core/anima/HEXAD/NEUROMORPHIC/state/scale_vspont_fire_s174_2026_05_20"
...
def main():
    ...
    ap.add_argument("--ckpt", default=os.path.join(S167A_DIR, "ckpt_s174_scale_vspont.pt"))
