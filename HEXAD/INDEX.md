...
>
> **이전 substrate = deprecated → `archive/` (PR #82)**: AXIS/HYPOTHESIS/PHILOSOPHY/MAIN/CLM/VERIFY/NEXT/REBORN tape + .clm v1/v2/v3 ladder + BG-CORPUS pipeline 은 **HEXAD 이전 데이터** — 아래 인벤토리는 **양식 그대로 보존된 historical evidence anchor** (검증 근거 valid), active entry-point ❌. 이전 HF canonical (`dancinlab/anima-clm`+`dancinlab/anima-corpus`) = **RETIRED → `dancinlife/*` private (PR #97)**. **🎯 현재 canonical HEXAD HF artifacts (2026-05-17 BOTH LANDED PUBLIC)**: (1) Model — [`dancinlab/hexad @ v1-py-hexad-d768x12L-cycle2-2026-05-17`](https://huggingface.co/dancinlab/hexad/tree/v1-py-hexad-d768x12L-cycle2-2026-05-17) — **HEXAD 첫 canonical ckpt-bearing artifact** (Python substrate cycle 2 ckpt-RECOVERED, ckpt sha256 `e87e200a04…` 1.13 GB; honest framing: NOT hexa-native, anchor chain Phase E/E2 + ConsciousDecoderV2 arch identity); cycle 1 (`931dd68b0` 2026-05-16) ckpt-LOST 해소. (2) Dataset — [`dancinlab/hexad-corpus @ v1-byte-consciousness-d128-cycle1-2026-05-17`](https://huggingface.co/datasets/dancinlab/hexad-corpus/tree/v1-byte-consciousness-d128-cycle1-2026-05-17) — `corpus_consciousness_v1.jsonl` 151,943 B / 240 lines / sha256 `804664361e639be7…` / vocab=256 byte-level (6 modules × 40 chunks uniform), used_by 4-fire anchor chain (Phase E2 + .py cycle 1/2 + pure-hexa d=64·3L); honest framing: 152KB scaffold dataset, **NOT** general LM corpus. model card cross-link 적용 (front-matter `datasets:` + body 'Trained on' badge). *(구 framing 2026-05-15: AXIS/HYPOTHESIS/PHILOSOPHY/CLM = verification substrate under modules — superseded)*
>
