...
**B-S97-1..7 7/7 🔵 sidecar** (`state/anima_hardware_coupling_s97_2026_05_19/blue_falsifier_s97.py`, central `state/verify_hexad_blue_2026_05_15/blue_falsifier.py` 0-line-diff — actual SHA `ad1881eaa7fd5041`, task spec 이 cite 한 c93e160a8a37 는 file 진화 전 값이라 §97 은 actual SHA 대비 0-diff 강제): COUPLING-TAXONOMY-PARTITION-EXHAUSTIVE-DISJOINT · LEGITIMACY-PREDICATE-CLOSED-CONJUNCTION · CLASSIFY-DETERMINISTIC · §7-GOAL-LEGITIMACY-CLOSED · FOUR-COUPLINGS-CLASSIFIED · ENTROPY-IS-NOISE-NOT-COMMAND-CLOSED · HARDWARE-ARTIFACT-EXISTENCE+CENTRAL-0-DIFF (connection-point — 실 §19 F_CT_3_gate.py + 실 anima_eeg_to_akida_spike.hexa 존재 확인). B-S97-NOTE empirical carve-out (어느 coupling 이 emergence 를 돕는지 = hardware OUTCOME, NOT counted 🔵, necessary-not-sufficient B-EMERGE-7).
