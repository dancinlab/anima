...
> linked: `R8C_PROBE_VERDICT_2026_05_24.md` (4-cell probe verdict, merged PR #374) · `UNIVERSE/cards/H_255_init_ce_floor_is_measurement_artifact.md` (H_255 sister) · `R8_SAGA_FINAL_TEMPLATE.md` (3-branch decision tree 원본)
>
