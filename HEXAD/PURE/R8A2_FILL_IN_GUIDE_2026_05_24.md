...
2. `HYPOTHESES/cards/H_255_*.md` REVISION — STRENGTHENED status, axis 분리 — base: #1
...
5. `HYPOTHESES/cards/H_257_*.md` REFRAMING UPDATE — env-var silent-bypass + wiring saga combined closure — base: #4
...
4. `HYPOTHESES/cards/H_255_*.md` STRENGTHENED — init_CE/final_CE/n_strong decoupling — base: #3
...
3. `HYPOTHESES/cards/H_256_wiring_propagation_horizon_dependent.md` (신설 H_256) — base: #1
