...
# --- universe-brain-map anchors (corpus_carving_generator.KNUTH_ANCHORS) ----
# tier -> (name, category, top_emotion). The carving corpus only contains
# these 11 anchors; the eval probes exactly this anchor set (no fictional
# tiers — the first eval probed tier 73 which is not a corpus anchor).
ANCHORS = {
