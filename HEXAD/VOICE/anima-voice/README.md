...
|------|-----|-------------|
| anima_voice.hexa | 657 | Main pipeline orchestrator |
...
```bash
$HEXA anima/modules/anima-voice/anima_voice.hexa           # Pipeline demo
$HEXA anima/modules/anima-voice/streaming.hexa             # Streaming demo
$HEXA anima/modules/anima-voice/plc_crossfade.hexa         # PLC demo
$HEXA anima/modules/anima-voice/emotion_prosody.hexa       # Emotion demo
```
