# ANIMA-VOICE Mk.III — P4 Plan (D3 fleet, 2026-04-18)

## Discovery
- `shared/roadmaps/anima-voice.json` phases P0..P3 all `done`. No P4 defined.
...
## Stub built
`anima-voice/p4_streaming_tighten.hexa` — budget self-test with 3 gates.
...
## Next step
When P4 unfreeze: lift constants in `physical_limits.hexa` (CHUNK_FRAMES 6, FRAME_MS 5, FIRST_PACKET_MS 50) and re-run bench_anima_voice H2 with new target. No pod touch required.
