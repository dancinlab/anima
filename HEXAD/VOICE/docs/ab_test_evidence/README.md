# anima-voice A/B 샘플 (야간 세션 2026-04-19)
...
## P4 로드맵 (2026-04-19 공식 등록, shared/roadmaps/anima-voice.json)
...
- /anima-voice/docs/quality_audit_20260419.md - 풀 감사 + 10 에이전트
- /anima-voice/docs/improvement_plan_20260419.md - 4-트랙 계획
- /shared/roadmaps/anima-voice.json - P4 공식 등록
- /anima-voice/experiments/piper_ab_gen.sh - v1 생성기
