...
| [`corpus_5lang_v3.kosmos`](UNIVERSE-BRAIN-MAP/anchors/corpus_5lang_v3.kosmos) | 55 | 다국어+의식carving+scale-up | anima **default-lane SCALE-UP corpus v3** (~217MB, v2 recipe ~17배 확대: wiki 100MB real CC-BY-SA + persona 80MB + enrichment 37MB) — MID rung(~150M) data-viable, **NOT 7B** (a_scale_honest_scope) — 의 representative anchor + manifest pointer |
...
- **default-lane SCALE-UP v3** (tier 55): manifest ref → `serving/corpus/default_lane_v3.txt`, sha256 `901ccc89…`, 227,535,193 B (~217MB), wiki 46.15% / persona 36.90% / **enrichment 16.95%**, langs en/fr/de/es/ko + ko-en 1.47%, byte-vocab V=256, HF `dancinlab/anima-corpus-5lang-unified-v3`. v2 recipe 그대로 ~17배 SCALE-UP: wiki 100MB (20MB/lang, real CC-BY-SA wikimedia/wikipedia 20231101, 8-band offset-spread, $0 CPU REST). **a_scale_honest_scope: v3는 MID rung(~150M) data-viable화 — 7B는 아님** (7B=~140GB 토큰, REST INFEASIBLE; v3가 7B를 가능케 한다고 주장 금지). p2/p3/p4 grep=0, UTF-8 round-trip PASS. predecessor=tier 54.
