#!/usr/bin/env bash
# anima HF Cycle 2 Pβ cleanup — scheduled execution date 2026-05-08 (post 48h review window close)
# scope: ubu1 staging dir /home/aiden/anima_pbeta_50k_step50000/ + (optional) mac stage mirror
# gates: 2-gate verify before any rm; verb=DELETE_SCRIPT per feedback_cleanup_bg_guards.md
# REPO context: https://huggingface.co/need-singularity/clm-v4-paradigm-d-pbeta-50k-mk2-v1 (private at v1)

set -euo pipefail
shopt -s failglob 2>/dev/null || true

CYCLE="p9_pbeta_hf_upload_2026_05_05"
...
# ============================================================================
# GATE 2 — HF repo intact (siblings == 6, commit_sha matches)
# ============================================================================
...
# mac stage mirror — small (5 files), keep by default; flag --delete-mac-mirror to remove
...
log "DONE — HF Cycle 2 Pβ cleanup complete; reports at state/$CYCLE/cleanup_{pre,post}_state_*.txt"
