...
# ----- toy hyperparams (env-overridable for H_6112 scale-up sweep) -----
K       = int(os.environ.get("H6112_K","6"))
D       = int(os.environ.get("H6112_D","64"))
LAYERS  = int(os.environ.get("H6112_L","2"))
EXPERTS = int(os.environ.get("H6112_E","4"))
STEPS   = int(os.environ.get("H6112_STEPS","800"))
LR      = 1e-2
SEEDS   = [0, 1, 2]
