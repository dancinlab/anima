...
One-line summary: Paradigm J (active inference + J-VAE FE-loss) LoRA adapter for CLM v4 350M, trained on Phase 1.6 substrate, snapshot at step {{STEP}} of a 50,000-step run on RTX 5070 12GB.
...
```bibtex
@misc{anima_clm_v4_paradigm_j_50k_step_{{STEP_LABEL}}_2026,
  author = {anima / need-singularity},
  title  = {clm-v4-paradigm-j-50k-step-{{STEP_LABEL}}: Paradigm J active-inference LoRA, snapshot {{STEP_LABEL}}},
  year   = {2026},
  url    = {https://huggingface.co/need-singularity/clm-v4-paradigm-j-50k-step-{{STEP_LABEL}}}
}
```
