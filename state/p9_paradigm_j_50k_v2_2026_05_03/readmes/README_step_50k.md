...
# clm-v4-paradigm-j-50k-step-50k
...
```bibtex
@misc{anima_clm_v4_paradigm_j_50k_step_50k_2026,
  author = {anima / need-singularity},
  title  = {clm-v4-paradigm-j-50k-step-50k: Paradigm J active-inference LoRA, snapshot 50k},
  year   = {2026},
  url    = {https://huggingface.co/need-singularity/clm-v4-paradigm-j-50k-step-50k}
}
```
