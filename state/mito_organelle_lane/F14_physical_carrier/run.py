...
SEEDS = list(range(200, 220))          # 확증 (Fable 파일럿 950–985 와 disjoint)
PILOT_SEEDS = list(range(600, 620))    # MDE 전용 · 분석과 disjoint
