...
5. **Recipe is recreate-from-history; it does NOT preserve the inter-commit evolution** (양방향, production-first, self-폐기, INTERNAL-ONLY pivot). UPGRADE flattens to a single mk2 snapshot. If history-as-evidence matters, snapshot loses provenance richness.
