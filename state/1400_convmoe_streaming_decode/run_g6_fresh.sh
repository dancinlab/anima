#!/bin/bash
# H_1400 fresh-process per-frame G6 FALS re-score driver. Each frame = its OWN hexa process
...
PROBE=state/1400_convmoe_streaming_decode/g6_one_frame_fresh.hexa
OUT=state/1400_convmoe_streaming_decode/g6_fresh_frames.log
: > "$OUT"
GEN=110
