...
| 4 | n6-architecture | `.own.readme` | mk2_VERIFIED (n6-local schema) | POST_MK2_RECENT | 5 | docs/n6_architecture_own_readme_mk2_reconstruction_*.ai.md + absolute_rules.json | **KEEP** | mk2-compliant via n6-local schema variant `n6-architecture/own/readme/2`; documented mk2 reconstruction (mk1 retired commit 442afa7b) |
| 5 | n6-architecture | `.own.group_p` | mk2_VERIFIED (n6-local schema) | POST_MK2_EARLY | 1 (own#6 unified) | docs/n6_architecture_own_group_p_mk2_reconstruction_*.ai.md + own6/own31 lint | **KEEP** | same n6-local mk2 family as `.own.readme` |
...
| - | n6-architecture | `raw_archive/2026-05-04T/.own.group_p.bak` | BACKUP | - | - | already archived | **NO_ACTION** | byte-identical backup; raw#15 backup chain |
| - | n6-architecture | `raw_archive/2026-05-04T/.own.readme.bak` | BACKUP | - | - | already archived | **NO_ACTION** | byte-identical backup; raw#15 backup chain |
...
- `anima/.own`
- `n6-architecture/.own.readme`
- `n6-architecture/.own.group_p`
...
- `n6-architecture/raw_archive/2026-05-04T/.own.group_p.bak` — backup, leave per raw#15
- `n6-architecture/raw_archive/2026-05-04T/.own.readme.bak` — backup, leave per raw#15
...
| n6-architecture/.claude/worktrees | 3 | DEFER → worktree GC cycle |
