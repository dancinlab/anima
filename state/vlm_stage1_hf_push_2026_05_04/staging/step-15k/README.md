...
- Loaded by: `PeftModel.from_pretrained(atp_base, "need-singularity/vlm-anima-voice-paradigm-stage1-step-15k")`
...
@misc{anima_vlm_stage1_step15k_2026,
  ...
  year   = {2026},
  url    = {https://huggingface.co/need-singularity/vlm-anima-voice-paradigm-stage1-step-15k}
}
```
