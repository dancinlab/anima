...
| 🥇 Phase 1A.4 lr 5e-6 SFT v2 | D2 cond #1 (retry) | Vast.ai RTX 4090 pod 36617226 | `state/anima_phase1a4_lr5e6_2026_05_12/dispatch_vast_v2.sh` (direct-IP + MD5 verify + 3-retry rsync fallback) | **$0.014 actual** (sub-cent!) | 🎉 **★★★★★ ACHIEVED V5.8 std_greedy 5/5 PASS** — Phase 1A.1 baseline 4/5 → Phase 1A.4 v2 5/5 (anima_fact markdown attractor 깨짐). std_sample 1/5→3/5, M3 0/5→1/5, M4 5/5=5/5. wall 3.2 min. cond #1 ☑ DONE → **5-cond aggregate 3/5 ☑ → 4/5 ☑** (cond #1+#2+#4+#5) + cond #3 STRONG 4/5 carry. ckpt local pull in-flight, HF push pending |
