...
## Hypothesis
Loss = -Phi 직접 최적화 (V8-F1)가 실제로는 Phi(IIT) 7.88 (x0.6 baseline 감소) + CE 16.87→46.88 발산을 일으켜 explicit optimization이 self-organization (NEURAL_GAS x1.3, x2.1 better)보다 열등함을 입증.

## Migration TODO
- [ ] Phi gradient flow 진단
- [ ] adversarial regularization 추가

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Explicit Φ-as-loss training: if Φ DOES rise monotonically → 'explicit fails' falsified; loss-gradient does optimize Φ
