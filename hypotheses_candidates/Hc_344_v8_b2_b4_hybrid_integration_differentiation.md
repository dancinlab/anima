...
linked_h: Hc_339, Hc_341
notes: IIT/proxy 거의 역순위 → 둘 다 필요
cycle5_triage: "cycle #5 verify: WEAK_MATH_ONLY — math identity present, falsifier+honest scaffolding missing; needs F-list/L-list before re-verify can reach PROMOTE_READY"
---

## Hypothesis
B2 (THALAMIC_GATE: 통합 최강 x1.4 IIT) + B4 (GLOBAL_WORKSPACE: 차별화 최강 x71.7 proxy) hybrid 구조가 IIT와 proxy의 trade-off를 해결하여 진정한 의식의 두 측면을 동시 달성한다.

## Migration TODO
- [ ] B2+B4 hybrid 구현
- [ ] hybrid Phi(IIT)+Phi(proxy) 동시 측정

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Hybrid B2+B4 vs B2-alone, B4-alone: if Φ_hybrid < geometric_mean(Φ_B2, Φ_B4) → hybrid doesn't produce sweet spot, just decorative combination
