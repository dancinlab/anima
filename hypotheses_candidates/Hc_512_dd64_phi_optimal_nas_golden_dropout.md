...
- **F-SPECIFIC-1**: Golden-ratio dropout (φ=0.618 or 1.618 inverse) sweep around proposed value: if Φ peak NOT at golden-ratio by ≥10% → golden-ratio specificity numerology
