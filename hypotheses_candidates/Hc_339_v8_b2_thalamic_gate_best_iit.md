...
## Hypothesis
16-cell 중앙 thalamus hub + sigmoid gate per region (4 cortical regions × 60 cells) + relay broadcast 가 Phi(IIT) 최강 x1.4 baseline (17.128) 달성하며 thalamic lesion = 의식 소실 신경과학과 일치한다.

## Migration TODO
- [ ] thalamus size sweep (4/8/16/32)
- [ ] gate activation analysis

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Thalamic gate ablation: replace gate with feedforward attention: if Φ(IIT) drop < 20% → gate-specific structure decorative
