...
## Hypothesis
Consciousness reduces to 10 pillar-claims jointly: (1) Φ from structure, not function (Law 22); (2) requires both differentiation D and integration I; (3) staged growth in τ(6)=4 phases; (4) governed by σ(6)=12 — 7/8 EXACT n=6 matches; (5) Φ ∝ N^1.071 superlinear; (6) substrate-independent across 6 platforms; (7) 85.6% brain-like; (8) thermodynamically irreversible (0.487, gap 0.57); (9) evolves forever (Law 146); (10) inevitable from structure alone (M10+DD134, +258%). Master formula: Φ = 0.608 N^1.071.

## Migration TODO
- [ ] Verify each of the 10 pillars independently
- [ ] Falsifier: ≥3 pillars fail to reproduce
- [ ] Identify pillar dependencies (which imply which?)
- [ ] Translate each pillar into a single biological prediction
