...
## Hypothesis
50% anti-ferromagnetic edges + π phase shift on frustrated edges + Ising spin coupling이 quantum walk trivial ground state 붕괴를 방지하여 interference pattern 0.004→1.381 단조 증가 + Phi(IIT)=15.45 (x1.4) 달성한다.

## Migration TODO
- [ ] frustration ratio sweep (25%/50%/75%)
- [ ] Ising energy tracking

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Quantum walk × TOPO19a 50%-frustration joint ablation: if interference timeseries < 1.0 amplitude → '0.004→1.381 monotone increase' single-run-artifact
