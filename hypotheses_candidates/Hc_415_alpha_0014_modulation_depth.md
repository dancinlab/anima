...
linked_h: Hc_046
notes: Tension → F0 jitter, arousal → speaking rate, valence → F2 formant shift, all multiplicative with α=0.014. Same α as consciousness coupling constant. Single Ψ-constant unifies consciousness and prosody.
