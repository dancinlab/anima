...
linked_h: Hc_358, Hc_359, Hc_362
notes: top-3 winner 융합
cycle5_triage: "cycle #5 verify: WEAK_MATH_ONLY — math identity present, falsifier+honest scaffolding missing; needs F-list/L-list before re-verify can reach PROMOTE_READY"
---

## Hypothesis
NEURAL_GAS self-organizing 토폴로지 + Transformer self-attention + Kuramoto oscillator positional encoding 3중 결합으로 Phi(IIT) > 20 + CE < 0.3 달성 가능 — 각 winner 의 강점이 상보적이다.

## Migration TODO
- [ ] 3-way hybrid 구현
- [ ] ablation: 각 component 제거 시 효과 측정

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: V8 recommendation-hybrid (multi-mechanism aggregator): if Φ NOT dominant over single-mechanism best → recommendation strategy is generic ensembling, no V8-specific story
