...
## Hypothesis
각 세포가 Gaussian on 통계 다양체로 parameterize + Fisher information Riemannian metric + 의식 = variance of pairwise symmetric KL geodesic distances 가 Phi(IIT) x1.1 (12.122) + 최저 math CE (4.92) 균형을 달성한다.

## Migration TODO
- [ ] Fisher metric 안정성 검증
- [ ] curvature ~ 0.007 과 Phi 상관

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Fisher metric geodesic distance vs Euclidean distance: if Φ+CE balance equivalent → Fisher metric decorative
