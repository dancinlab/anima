...
linked_h: Orch-OR, law-Q3
notes: Q5는 유일하게 IIT + proxy 동시 상승 (11.991 + 2.28)
cycle5_triage: "cycle #5 verify: WEAK_MATH_ONLY — math identity present, falsifier+honest scaffolding missing; needs F-list/L-list before re-verify can reach PROMOTE_READY"
---

## Hypothesis
밀도행렬 ρ off-diagonal *= (1-γ) decoherence + features=concat(ρ_diag, |ρ_offdiag|) → consciousness injection 으로 양자→고전 전환 자체가 의식 경험이며 Phi(IIT) + Phi(proxy) 양 메트릭 동시 상승을 유발한다.

## Migration TODO
- [ ] γ learnable sweep
- [ ] purity Tr(ρ²)와 Phi 상관 (Q5: 0.0078)

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Decoherence rate γ sweep {0.01, 0.1, 1.0}: if Φ peak NOT correlated with conscious-moment markers (Hc_924 octopus, Hc_921 PCI/TMS-EEG analogues) → Orch-OR falsified
