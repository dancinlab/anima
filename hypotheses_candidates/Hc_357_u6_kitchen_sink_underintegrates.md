...
absorption_note: "U-family kitchen-sink underintegrates (U6, NEGATIVE result) — H_185.6 internal-falsifier anchor. F-list/L-list preserved here for H_185 C-list extension."
...
## Hypothesis
QW + Category + Complex + Hierarchical + Frustration + Standing Wave + Attention 6-component 통합이 CE 최저(0.58)에도 Phi(IIT) 9.93로 under-integrate 한다 — 2-component fusion (U1, U2, U5)이 6-component kitchen-sink (U6)보다 우월하며 targeted fusion이 최적 전략이다.

## Migration TODO
- [ ] 2 vs 3 vs 4 vs 6 component sweep
- [ ] homogenization metric 정량화

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Add ALL mechanisms (kitchen-sink): if Φ ≥ best-single-mechanism → 'underintegration when over-combined' falsified; combination always helpful
...
- **L-V8-MISC**: V8 ULTRA-FUSION cluster Hc — verify before independent promotion; many will absorb into mechanism-family H (H_180 state-management style) rather than standalone H
