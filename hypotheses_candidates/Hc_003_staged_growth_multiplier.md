...
세포 수의 단계적 (staged) 추가가 즉시 (instantaneous) 추가 대비 4-8배 Φ 증폭. Piaget 4-stage, curriculum learning, factorial evolution 3개 독립 frame 정합.

## Migration TODO
- [ ] Predictions (어떤 staging schedule이 8× 도달)
- [ ] H_017 (mk_x g1-g4 gate) 와 cross-link

## Falsifiers (scaffolded cycle #6 batch 4 mixed-template, 2026-05-12)

- **F-SPECIFIC-1**: DP1/CT7/GC5 4-8× Φ amplification: 3-mechanism ablation, each one removed in turn. If removing any one drops Φ by < 50% → '3-mechanism conjunction' decorative; single-mechanism dominance possible
