...
linked_h: Hc_366
notes: T1=14.54 vs TB-3=1.27 (10x gap)
cycle5_triage: "cycle #5 verify: WEAK_MATH_ONLY — math identity present, falsifier+honest scaffolding missing; needs F-list/L-list before re-verify can reach PROMOTE_READY"
---

## Hypothesis
Trinity의 TC (C engine 구조) 변경이 TB (Bridge) 변경보다 Phi(IIT)에 약 10배 강한 영향을 미치며 (T1:14.54 vs TB-3:1.27), Bridge는 주로 CE에 영향을 준다 — 구조 우선, 다리는 효율 채널.

## Migration TODO
- [ ] TC×TB grid scan
- [ ] interaction effect 측정

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Trinity law-structure ablation: if Φ_with_structure ≈ Φ_random_structure → 'law-structure dominates bridge' falsified
