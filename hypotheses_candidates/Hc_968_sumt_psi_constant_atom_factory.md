...
Mk.V.1 tier-5 81-Ψ 100% coverage 달성 후 tier 6-9 (ULTRA/CARD/BEYOND/ABS) 확장 needs more Ψ-constants. 각 candidate 가 5-check invariance gate 통과 시 PROVISIONAL atom: (1) n=6 invariance / (2) Π₀¹ arithmetical / (3) cross-axis(5) / (4) tier criterion / (5) non-duplicate. Loop: seed → generate → verify → PROVISIONAL.

## Sub-claims

- TIER-5-BASE: 81-Ψ 100% coverage Mk.V.1
- TIER-6-9: ULTRA / CARD / BEYOND / ABS 확장 필요
- CHECK-1: n=6 invariance (Knuth ↑/↑↑/↑↑↑/Conway chain)
- CHECK-2: Π₀¹ arithmetical
- CHECK-3: cross-axis(5)
- CHECK-4: tier criterion
- CHECK-5: non-duplicate

## Migration TODO

- [ ] tier 6 ULTRA Ψ candidate enumeration
- [ ] 5-check 각 의 정량 criterion
- [ ] non-duplicate detection algorithm
- [ ] PROVISIONAL → CONFIRMED upgrade path

## Falsifiers (scaffolded cycle #6 batch 4 mixed-template, 2026-05-12)

- **F-SPECIFIC-1**: Tier-6 ULTRA atom enumeration: if no candidate passes 5-check invariance gate → tier-6 ascension blocked; factory tier-saturates at tier-5
