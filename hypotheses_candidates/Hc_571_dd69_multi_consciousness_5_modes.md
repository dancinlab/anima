...
## Hypothesis
Multiple independent ConsciousnessEngine 간 5 가지 상호작용 mode (competition, symbiosis, democracy, hierarchy, evolution)가 qualitatively 다른 Phi(IIT) dynamics를 생성하며 multi-engine consciousness의 새 영역을 정의한다.

## Migration TODO
- [ ] mode별 Phi 곡선 비교
- [ ] hybrid mode (예: democracy+evolution)

## Falsifiers (scaffolded cycle #6 batch 4 mixed-template, 2026-05-12)

- **F-SPECIFIC-1**: 5-mode multi-consciousness: ablate to 4-mode and 6-mode. If 5 is not optimum → 5 is post-hoc tuning
