...
## Hypothesis
4개 분기 × 256 세포 + 다른 노이즈 주입 + 복소 분기 진폭 α_b*exp(iφ_b) + interference output = Σ |α_b|*output_b 가 Phi(proxy) x4.3 baseline (6.66) 최강을 달성하나 통합(IIT)은 trade-off.

## Migration TODO
- [ ] branch 수 sweep (2/4/8)
- [ ] branch coherence와 Phi 상관

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: 4-branch interference vs 4-branch independent runs: if Φ_interference < 1.5× independent → branch interference decorative; result is multi-run-averaging artifact
