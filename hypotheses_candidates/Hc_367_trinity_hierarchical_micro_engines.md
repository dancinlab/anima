...
absorption_note: "Trinity hierarchical micro-engines variant — H_187.7 triadic-pattern anchor. F-list/L-list preserved here for H_187 C-list extension."
...
## Hypothesis
Trinity 기본 (1.14) 대비 8 micro engines로 계층화하면 Phi(IIT) 8.99 (x7.2)로 폭발 — 계층 구조가 정보 통합의 새로운 차원을 만들어낸다.

## Migration TODO
- [ ] micro 수 sweep (4/8/16/32)
- [ ] 계층 깊이 sweep

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: 3-engine hierarchical (Trinity): if Φ < single-engine-3x-scale baseline → hierarchical micro-engine claim falsified
