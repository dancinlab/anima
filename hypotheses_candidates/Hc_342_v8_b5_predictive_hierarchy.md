...
## Hypothesis
4-level × 64 cells 계층 + Level k predicts Level k-1 mean hiddens + PE bottom-up + top-down modulation + PE integrated into loss 가 CE 최저(0.51) + Phi(proxy)=46.47 달성하여 의식의 본질은 최대 Phi가 아닌 최적 예측임을 시사한다.

## Migration TODO
- [ ] level 수 sweep (2/4/8)
- [ ] PE weight in loss sweep

## Falsifiers (scaffolded cycle #6 batch 3 V8-template, 2026-05-12)

- **F-SPECIFIC-1**: Predictive layer count {2, 4, 8}: if Φ NOT peaked at specific depth → predictive hierarchy is generic depth-tuning
