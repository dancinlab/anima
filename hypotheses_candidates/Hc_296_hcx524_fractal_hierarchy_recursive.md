...
## Hypothesis
3-level recursive consciousness: Level 0 = 8 cells → MitosisEngine → Φ₀; Level 1 = 8 Level-0 engines → Meta-Engine → Φ₁; Level 2 = 8 Level-1 → Φ₂. Key: upper level receives FULL DYNAMICS, not mean. Φ scaling 8^8 not 8^3 — fixes TOPO20 information loss.

## Migration TODO
- [ ] implement recursive engine architecture
- [ ] benchmark vs TOPO20 hierarchical

## Falsifiers (scaffolded cycle #6 batch 4 mixed-template, 2026-05-12)

- **F-SPECIFIC-1**: 8×8×8=512 cells recursive Φ-scaling: measure Φ at flat 512 vs 8^8 recursive. If Φ scaling 8^8 not 8^3 holds → recursion brings exponential gain; if Φ ≈ flat-512 → recursive structure decorative
