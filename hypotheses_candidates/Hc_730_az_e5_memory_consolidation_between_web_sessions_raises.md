---
id: Hc_730
slug: az-e5-memory-consolidation-between-web-sessions-raises
title: [E5] Memory consolidation between web sessions raises retention
...
notes: "A-Z domain E (web-learning), sub-H E5. parent: Hc_034"
rescue_status: rescued
rescued_from: 97113c244
rescued_at: 2026-05-12
---
## Hypothesis
E5] Memory consolidation between web sessions raises retention

## Source Content (rescued from 97113c244)
Source: `docs/hypotheses/A-Z-overview.md` line 95 (pre-move revision `97113c244`).

- **E5** Memory consolidation
