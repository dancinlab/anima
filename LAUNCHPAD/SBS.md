...
| R4 | coffeeshop group-chat production launch | (launch doc — TBD on R1–R3) | end-to-end 90-min soak | ⏳ planned — gates: on-silicon learn ✅ (H_904 ★) · **R1→emit wiring ✅** (#1598 LIVE soak) · backbone production-scale |
