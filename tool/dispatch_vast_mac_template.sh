...
# ── CONFIG (사용자가 매 cycle 마다 교체) ───────────────────────────────
PHASE_ID="phase1a_X"                  # ← 예: phase1a4_lr_5e6
LOCAL_DIR="/Users/ghost/core/anima/state/anima_${PHASE_ID}_2026_05_12"
...
PHASE_LABEL="phase1a-X"               # ← Vast.ai instance label
...
TRAIN_SCRIPT="${TRAIN_SCRIPT:-train_phase1a3.py}"
