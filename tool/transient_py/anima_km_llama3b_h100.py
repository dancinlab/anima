...
Eval:
 ...
 SSOT mirror (c3-aggregation-rule-v2 P5 N-of-M v2):
    ...
    (trinity sweep V iolation 1 retract path). D1 scope-clamp 정합:
...
def pod_main():
    ...
    verdict = {
        ...
        "scope_lane_reason": "Llama-3.2-3B foundation borrow = ALM lane → strict SUBSTRATE_RESEARCH lane only",
        "lesson_implications": [
