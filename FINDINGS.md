...
| **G6** IDEATION **발상** ★ | ≥5 distinct corpus-absent ideas + ≥1 falsifiable hypothesis from one seed | 🟠 THIN | 4/5 distinct + **9 corpus-absent novel grams** (generativity real); depth-floor thin. H_1304 dig: a NEW deterministic p7 falsifiability detector (comparator+measurable+negatable, 10/10 calib) confirms flat ideation scores **0 falsifiable**; composition-routed (G1 recombination) ideation lifts FALS **0→0.667** (one falsifiable idea earned) + NOVEL 6→19 but does NOT cross count≥5 or depth≥1; shuffle/ablate controls collapse to 0 → bar UNMOVED (c9, a_break_the_wall: angle tried, wall held) |
