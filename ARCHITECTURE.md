...
| **HD26** | **📡 시상** (thalamus) | H_1283 | 전역작업공간 중계 / 방송 (global-workspace relay) | 🧱 **WALL** (R5) — relay-topology Φ 축 EXHAUSTED: broadcast(R1/R2) falsified · sparse re-entry(R3/R4) seed-conditional(seed8 +0.0101<bar) · **dense all-pairs re-entry(R5) ALSO seed8 +0.0060<bar AND shuffle control FIRED**(permuted graph ~91%/76% of lift → 리프트는 구조 아닌 added-edge variance). 모든 relay topology 가 robust +0.02-every-seed Φ bar 미달 |
