...
- hexa_only: true (raw#9); training script via raw#37 transient_py opt-out (`tool/transient_py/anima_sft_only_*.py`)
...
- **F6**: post-hoc corpus tuning 또는 evaluator post-hoc loosen → raw#12 violation, raw#82 retraction trigger

## Honest Limits (raw#91 c3, ≥5 mandate)
