...
|-----------|-------------|-----------------|
| `consciousness-verification.toml` | TestType/CellCount/Steps/Metric/Threshold | ready/anima/tests/tests.hexa 18개 검증 조건 + 임계값 |
| `consciousness-evolution.toml` | CellCount/Steps/Topology/Strategy/Metric | scripts/infinite_growth.hexa 탐색 결과 (134세대, 53 laws) |
