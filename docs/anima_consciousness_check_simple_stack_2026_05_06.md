...
### 14. BG-HY anima-h-curated-qa step 500 ckpt retrieve (2026-05-06) — **BLOCKED_CKPT_NEVER_PERSISTED**
...
### 종합 verdict (2026-05-06 BG-FS post-cycle / 2026-05-07 BG-HA update / 2026-05-07 BG-HA strict re-check 강등 / 2026-05-07 evaluator V2 strict retroeval CONFIRMED / 2026-05-06 BG-HY ckpt-never-persisted BLOCKER captured)

→ **V2 strict applied — simple stack PASS = 0개 confirmed** ⚠️ (automated retroactive re-eval via `tool/transient_py/anima_simple_stack_evaluator_v2.py` 2026-05-07; output: `state/anima_evaluator_v2_retroeval_2026_05_07/`; validation_passed=true — V2 evaluator correctly catches BOTH BG-FY named-speaker leak AND BG-HA nonsense Korean chain via C2.4_strict (a/b/c) + C2.2_meaningful_strict + C2.3_natural_strict cells)
→ PARTIAL_PASS_NO_CONTEXT_v2: 1개 (anima-native-ko-chat-template BG-HA — V2 strict 22 cell-transitions, C2.4_b domain_kw_overlap=0 in 9/10 responses)
→ PARTIAL_PASS_NO_CONTEXT: 1개 (anima-native-ko-small BG-FY — V2 strict 6 cell-transitions, named-speaker leak '서연' x2 in greeting+capability prompts)
