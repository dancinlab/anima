...
| F-CLM-LORA-5 — shim v4 hf_format compatibility | **PASS** | `state/clm_v4_lora_sft_2026_05_05/verdict.json:F_CLM_LORA_5_shim_v4_hf_format_compat` | AutoModelForCausalLM.from_pretrained('dancinlab/clm-v4-mk2-v1', trust_remote_code=True) succeeds; PeftModel.from_pretrained(base, adapter_dir) succeeds; logits shape valid + finite. |
