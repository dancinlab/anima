...
- `/Users/ghost/core/anima/bench/zeta_likert.hexa` (810 LoC, source-of-truth)
- `/Users/ghost/core/anima/bench/zeta_likert/v1_frozen.json` (20 prompts, sha256 eadede71...)
- `/Users/ghost/core/anima/tool/zeta_likert_freeze.hexa` (309 LoC, freeze tool)
- `/Users/ghost/core/anima/state/zeta_likert_v1_sha256.json` (sha manifest)
- `/Users/ghost/core/anima/state/zeta_likert_result.json` (verdict=FRAMEWORK-VERIFIED, 2026-04-23)
- `/Users/ghost/core/anima/bench/persona_lore_style_bench.hexa` (별도 bench, zeta baseline 3.2/3.0/2.8 — 비교 reference)
- `/Users/ghost/core/anima/tool/serve_alm_persona.hexa` (anima endpoint candidate, 현 BACKEND_PENDING)
- `/Users/ghost/core/anima/tool/anima_serve_smoke.hexa` (3-endpoint contract freeze)
- `/Users/ghost/core/anima/tool/anima_serve_live_smoke.hexa` (P2 gate live reachability)
- `/Users/ghost/core/anima/.roadmap` line 1210-1216 (#78 entry)
