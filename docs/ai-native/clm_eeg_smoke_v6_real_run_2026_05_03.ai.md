...
**Tier (raw#10 honest C3)**: `functional_analog`, N=1.
...
This projection is **NOT a verdict claim** (raw#71 — no falsifier-bound threshold relaxation, but also no fabrication of a verdict from non-executed runs).
...
This is not a bug — it is the FROZEN-DRY-RUN-AGGREGATOR contract surfacing under raw#10 honest review. The harness was designed to attest synthetic chain wiring, not real fixture evaluation.

---

## 5. raw#10 honest C3 caveats (real-fixture context)
...
Per raw#71: this is documented honestly here; no thresholds were relaxed; no real outputs were laundered into the synthetic surface; no SSOT v2 was silently bumped.
...
raw#9 hexa-only · raw#10 honest C3 functional_analog tier · raw#71 falsifier-bound · raw#82 silent-land marker chain integrity preserved · raw#91 honest C3 on harness aggregator semantics
