...
tool/active_redteam_*.py 3 files (grandfather opt-out)
tool/anima_holographic_ib_ksg_*.py 1 file (explicit raw 9 relaxation 2026-04-28)
ready/*.py 1431 files (opt-out)
