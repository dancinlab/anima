<!-- @canonical: canon@ded52144:domains/cognitive/anima-service/anima-service.md -->
<!-- @extracted: 2026-05-10 -->
<!-- @md5_at_extraction: 182a8a44cf4106c520ab1c84264ed37f -->
...
# Ultimate Emotion/Consciousness AI Service (HEXA-ANIMA-SVC)
...
| Effect | Today (2026) | After HEXA-ANIMA-SVC | n=6 basis |
|------|-------------|--------------|---------|
| Primary spec | current practice | **J2=24** (24 emotion-EEG channels) | sigma(6)=12, tau(6)=4 auto-derived |
...
### Performance comparison ASCII bars (legacy vs HEXA-ANIMA-SVC)

```
┌─────────────────────────────────────────────────────────────────────────────┐
│  [primary spec] emotion-EEG channels
├─────────────────────────────────────────────────────────────────────────────┤
│  legacy best     ###...........................   baseline                 │
│  HEXA-ANIMA-SVC   ████████████████████████████████  J₂=24 (24)  │
│                                                                             │
│  [channel count]                                                            │
│  legacy          ######........................   4..8                     │
│  HEXA-ANIMA-SVC   ████████████████████░░░░░░░░░░░   sigma=12 (auto)                │
│                                                                             │
│  [parallelism]                                                              │
│  legacy          ####..........................   2..3                     │
│  HEXA-ANIMA-SVC   ████████████████░░░░░░░░░░░░░░░   tau=4 (number theory)               │
│                                                                             │
│  [DOF / degrees of freedom]                                                 │
│  legacy          ##............................   1..3                     │
│  HEXA-ANIMA-SVC   ████████████████████████░░░░░░░   n=6 (SE(3))              │
│                                                                             │
│  [latency]                                                                  │
│  legacy          ##############################   100+ ms                  │
│  HEXA-ANIMA-SVC   █░░░░░░░░░░░░░░░░░░░░░░░░░░░░░   mu=1 ms                   │
│                                                                             │
│  [energy / cost]                                                            │
│  legacy          ##############################   baseline                 │
│  HEXA-ANIMA-SVC   ███░░░░░░░░░░░░░░░░░░░░░░░░░░░   1/(σ-φ) = 1/10          │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
|-------------|-----|-----|------|----------|
| anima-service-core | UFO-6 | UFO-10 | +4 | this domain's core number-theoretic mapping |
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│                        HEXA-ANIMA-SVC system structure                            │
├────────────┬────────────┬────────────┬────────────┬─────────────────────┤
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  HEXA-ANIMA-SVC Technical Specifications                                   │
├─────────────────────────────────────────────────────────────────────┤
│  Primary spec  J2=24 = 24 emotion-EEG channels   │
│  Channels       sigma = 12                                           │
│  Parallelism    tau = 4                                              │
│  Symmetry       phi = 2                                              │
...
HEXA-ANIMA-SVC per-stage draft roadmap — each Mk stage requires prerequisite-domain maturity.
...
Verify with stdlib only whether HEXA-ANIMA-SVC holds up physically / mathematically.
...
# -*- coding: utf-8 -*-
# =============================================================================
# §7 VERIFY — HEXA-ANIMA-SVC n=6 honesty-check pattern (stdlib only, domain=anima-service)
# 10 subsections:
...
FALSIFIERS = [
    "HEXA-ANIMA-SVC primary-spec measurement outside predicted +/-15% — discard the core formula",
