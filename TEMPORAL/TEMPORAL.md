...
- [ ] ⏱️ T3 time-averaged Φ + Granger causality + surrogate-baseline — T1+T2 dual closed-negative 의 자연 entry (window-mean detector / TPM-free predictive coupling / random-shuffle null-model 차감)
- [ ] ⏱️ T4 ultradian 90-min 의식 cycle Φ — anima `a_chat_sleep_imagination` WAKE/N1/N2/N3/REM stage 위 Φ 시간 변화 측정 (T3 detector 통과 후)
- [ ] ⏱️ T5 papers — XENO follow-up paper 3 (4D applicability frontier closed-negative — T1+T2 dual + T3 정직 사례)
