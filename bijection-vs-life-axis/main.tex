...
\item A scale-rotation result: at n$=$6 the dominant rule switches
      ...
      of a single rule.
\item All twenty-five measurements are published as a
...
the proxy, not in the scale. The \#attractor$\leftrightarrow\Phi$
coupling ($\approx -0.8$ at both exact $n$) is the stable cross-family
bridge.}
\label{tab:sc2}
\end{table}
...
All twenty-five cells live as JSON ledgers under
...
against the public \texttt{anima} main branch. All twenty-five
