...
## 2026-06-17 — fix(ENGINE+CLM): H_1400 — STREAMING/BOUNDED ConvMoE .clm 디코드: 🟢 GREEN (H_1392 메모리 폭발 벽을 anima-side 에서 FIX, byte-exact; GEN=110 해제 → M2-M5 FALS 재채점 측정가능)
