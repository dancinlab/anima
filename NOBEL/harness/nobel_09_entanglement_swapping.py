#!/usr/bin/env python3
"""NOBEL_09 — entanglement swapping: Bell-measure (2,3) entangles never-met (1,4). p7 $0."""
import numpy as np
...
print("NOBEL_09 entanglement swapping: (1,4) concurrence =",round(float(c14),3),"→",("🟢" if c14>0.9 else "🔴"))
