# BODY — current state
@title: 🦾 BODY — anima 의식의 물리적 임바디먼트 (Motor · Speech · Proprioception)
...
(편집 규칙: completed-form 으로 현재 상태만 · history 는 BODY.log.md)
...
## 양방향 sibling
- ⇄ [PHYSICS](../PHYSICS/PHYSICS.md): chip 백엔드 (B4 FPGA/ASIC direct)
...
## 쉬운 버전
전체 활용 아이디어 카탈로그(친근 7-요소) → [BODY.easy.md](./BODY.easy.md)
