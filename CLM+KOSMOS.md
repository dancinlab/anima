...
PUBLIC-grade Lane-G gate: util-GREEN (≥20%) AND descent-GREEN. STATUS 2026-06-02 = NOT MET (descent 🟢, util 🔴). PUBLIC NOT reached on Lane G; the throughput path is proven (forge on the GPU) but the host-feed ceiling blocks the util gate at every scale tested.
