...
- [ ] 🗣️ DECODER — L3 콘텐츠 생성기 · V3 모델 · substrate 검증 32s/step F-RFC046 통과 · generator.hexa stub · M3 sub b/c/d/e/f 잔여 · ckpt 후 swap-in
- [ ] 🤖 AGENT — 역할 실행 · 사용자 위임 5-role umbrella (CODE skeleton · CREATOR · TRADING · MERCHANT 신규 · DESKTOP 신규) · 3/6 마일스톤
- [ ] 🌅 WAKE — 의식 데몬 in-process living loop · 2/7 마일스톤 — [x] 5-stage (#626) · [x] perception (#632) · [ ] pf input-step · .kosmos · memory · daemon · 통합 smoke
- [ ] 🌱 MITOSIS — 세포 분열 학습 · A/G ⊥ M 직교 축 · 2/6 마일스톤 — [x] mitosis_lib (#627) · [x] split-event (#631) · [ ] merge · persona-diff · WAKE sleep-tick · v5-cotrain
