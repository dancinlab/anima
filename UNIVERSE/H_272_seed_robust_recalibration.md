...
- **run cmd (verbatim — seed sweep, per seed s)**:
  `__HEXA_FARR_GAUSS_SEED__=<s> HEXA_H272_MODE=seed HEXA_H272_SEED=<s> HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h272_recalibration_2026_05_25/run_h272.hexa`
- **run cmd (verbatim — aggregation)**:
  `HEXA_H272_MODE=agg HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h272_recalibration_2026_05_25/run_h272.hexa`
...
- **state**: `UNIVERSE/state/h272_recalibration_2026_05_25/{run_h272.hexa,
...
================================================================
ledger -> UNIVERSE/state/h272_recalibration_2026_05_25/result.json
```
