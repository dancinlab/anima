...
- **⚠ H_661 (sister — *다른 측정*)** — H_661 은 **class 확대 일반화 = scale-inv 1속성을 多rule 로** (axis 확장), 본 **H_663 은 class-I 1행을 全속성으로** (속성 축 채움). 측정 축이 직교 — H_661=속성 1×rule N, H_663=class-I 1×속성 ≥3. 동시 진행 시 충돌 없음 (다른 cell).
