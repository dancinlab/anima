...
- **UNIVERSE LIFE-Cycle-#7-§G pick #3**: 'language' domain promote rank 10
...
**State output**: `UNIVERSE/state/h212_language_compositionality_2026_05_23/{run_h212.hexa, result.json}`
