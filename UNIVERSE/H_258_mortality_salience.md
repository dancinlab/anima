...
- **hexa_only**: `UNIVERSE/state/h258_mortality_salience_2026_05_25/run_h258.hexa`
...
- **artifacts**: `state/h258_mortality_salience_2026_05_25/{run_h258.hexa,
  result.json}`.
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h258_mortality_salience_2026_05_25/run_h258.hexa`
...
- **state**: `UNIVERSE/state/h258_mortality_salience_2026_05_25/{run_h258.hexa,
  result.json}`.
...
================================================================
ledger -> UNIVERSE/state/h258_mortality_salience_2026_05_25/result.json
```
