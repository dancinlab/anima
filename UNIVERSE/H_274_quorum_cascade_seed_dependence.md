...
- **run cmd (verbatim — seed sweep, per seed s)**:
  `__HEXA_FARR_GAUSS_SEED__=<s> HEXA_H274_MODE=seed HEXA_H274_SEED=<s> HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h274_cascade_seed_2026_05_25/run_h274.hexa`
- **run cmd (verbatim — aggregation)**:
  `HEXA_H274_MODE=agg HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h274_cascade_seed_2026_05_25/run_h274.hexa`
...
- **mitosis machinery**: `tool/hexa_native/mitosis_hook_lib.hexa`
  ...
  의 원천. `UNIVERSE/lib/phi_native.hexa` 는 Φ proxy sister (본 cycle 미사용).
...
- **lesson pointer**: PSCC §45/§49 (F-PERSONA-4 seed-fragile, §A2-trap noise-floor)
  ...
  fragility 분해* 의 확장.
- **state**: `UNIVERSE/state/h274_cascade_seed_2026_05_25/{run_h274.hexa,
...
================================================================
ledger -> UNIVERSE/state/h274_cascade_seed_2026_05_25/result.json
```
