# H_1876 — disagreement-selfplay (#23+#35)
...
2. 신규 각도면 cheap numpy DIRECTIONAL reachability probe → `state/1876_gen_disagreement_selfplay/`.
3. DIRECTIONAL GREEN 이면 engine-native 재측정(.hexa via core/) 사다리 진입(a_verified_must_wire).

## artifacts

- `cards/H_1876_gen_disagreement_selfplay.md` (this card)
- `state/1876_gen_disagreement_selfplay/` (probe 발사 시 생성)
