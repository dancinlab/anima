...
- **smoke**: `UNIVERSE/state/h222_dream_rem_phi_2026_05_24/run_h222.hexa`
...
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h222_dream_rem_phi_2026_05_24/run_h222.hexa`
