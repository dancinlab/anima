...
`state/6169_g6_attn_capacity_terminal/` — RESULT.md · CKPT_MANIFEST.md · ckpt/inj_REG{on,off}_N2_s7.pt (pulled, sha-verified) · eval_logs/eval_{base,regon,regoff}*.log · train_save_cell.py (DIRECTIONAL trainer)
