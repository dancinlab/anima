...
- hexa_only: true — `UNIVERSE/state/h210_ethic_emergence_2026_05_23/run_h210.hexa`
...
- run:
  ```
  hexa parse UNIVERSE/state/h210_ethic_emergence_2026_05_23/run_h210.hexa
  HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h210_ethic_emergence_2026_05_23/run_h210.hexa
  ```
...
- **UNIVERSE/H_054 Symbiogenesis**: endosymbiosis = mitosis MERGE 가 *통합
  사건*; 본 H 는 그 통합의 *동력원* (kin-selection payoff differential)
  substrate-level evidence — cooperation-as-merge analog 의 *evolutionary*
  ground.
- **UNIVERSE/H_018 Genesis**: self-feedback substrate genesis (외부 perturb
...
`UNIVERSE/state/h210_ethic_emergence_2026_05_23/run_h210.hexa`
...
VERDICT: SUPPORTED  (4/5 falsifiers PASS)
  result.json -> UNIVERSE/state/h210_ethic_emergence_2026_05_23/result.json
================================================================
```
