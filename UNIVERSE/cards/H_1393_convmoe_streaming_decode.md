...
# H_1393 — STREAMING / BOUNDED ConvMoE .clm decode (the H_1392 memory-blowup FIX)
...
upstream (hexa-lang inbox). H_1393 treats it as **wrong-method, not a ceiling** and FIXES it
anima-side.
...
- probe: `state/1393_convmoe_streaming_decode/{rss_probe.hexa, rss_probe_303m.hexa, g6_fals_probe_loaded.hexa}`
- verdict: `.verdicts/1393_convmoe_streaming_decode/{FREEZE.txt, byte_exact.txt, rss_before.txt,
