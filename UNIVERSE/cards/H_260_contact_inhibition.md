...
- **hexa_only**:
  `UNIVERSE/state/h260_contact_inhibition_2026_05_25/run_h260.hexa`
...
- **artifacts**: `state/h260_contact_inhibition_2026_05_25/{run_h260.hexa,
  result.json}`.
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h260_contact_inhibition_2026_05_25/run_h260.hexa`
  (CWD = worktree root)
...
- **legacy archive**: `hypotheses_legacy_2026_05_15/` (original 10-section
  양식 carry).
- **state**: `UNIVERSE/state/h260_contact_inhibition_2026_05_25/{run_h260.hexa,
  result.json}`.
...
================================================================
ledger -> UNIVERSE/state/h260_contact_inhibition_2026_05_25/result.json
```
