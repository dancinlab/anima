...
wired: engine-native (§AllostericBuffer ops LIVE in core/engine_cli.hexa + 5 smoke cases 314-318; 🧱 ⇒ NO live emit/decision wiring — a_verified_must_wire is GREEN-only)
...
`core/engine_cli_smoke.hexa` cases 314-318 (full smoke 0 fail, deterministic ×3). 🧱 ⇒ NO live
