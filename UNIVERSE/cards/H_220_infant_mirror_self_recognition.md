...
- **hexa_only**: `UNIVERSE/state/h220_infant_mirror_2026_05_23/run_h220.hexa`
...
- **artifacts**: `state/h220_infant_mirror_2026_05_23/{run_h220.hexa,
  result.json}`.
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 __HEXA_FARR_GAUSS_SEED__=42 hexa run UNIVERSE/state/h220_infant_mirror_2026_05_23/run_h220.hexa`
...
- **state**: `UNIVERSE/state/h220_infant_mirror_2026_05_23/{run_h220.hexa,
  result.json}`.
...
================================================================
ledger -> UNIVERSE/state/h220_infant_mirror_2026_05_23/result.json
```
