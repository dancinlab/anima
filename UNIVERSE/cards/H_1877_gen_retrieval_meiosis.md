# H_1877 — retrieval-meiosis (#19+#9)

**id:** H_1877
**slug:** gen_retrieval_meiosis
...
**메커니즘:** 앵커 풀서 둘 검색→crossover→hybrid 앵커 생성·영속.
...
2. 신규 각도면 cheap numpy DIRECTIONAL reachability probe → `state/1877_gen_retrieval_meiosis/`.
3. DIRECTIONAL GREEN 이면 engine-native 재측정(.hexa via core/) 사다리 진입(a_verified_must_wire).

## artifacts

- `cards/H_1877_gen_retrieval_meiosis.md` (this card)
- `state/1877_gen_retrieval_meiosis/` (probe 발사 시 생성)
