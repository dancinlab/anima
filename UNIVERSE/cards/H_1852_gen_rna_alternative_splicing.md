# H_1852 — RNA alternative splicing
...
2. 신규 각도면 cheap numpy DIRECTIONAL reachability probe → `state/1852_gen_rna_alternative_splicing/`.
3. DIRECTIONAL GREEN 이면 engine-native 재측정(.hexa via core/) 사다리 진입(a_verified_must_wire).

## artifacts

- `cards/H_1852_gen_rna_alternative_splicing.md` (this card)
- `state/1852_gen_rna_alternative_splicing/` (probe 발사 시 생성)
