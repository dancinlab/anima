---
id: H_1076
slug: freq-dep-diversity
title: 빈도의존선택이 다양성 보존
...
verdict: 🟢 SUPPORTED — 다양성(엔트로피) 빈도의존 1.10 vs 순수선택 0.74. 희소이점이 다형성 유지.
---

# H_1076 — 빈도의존선택이 다양성 보존

> **가설.** 빈도의존선택이 다양성 보존

## 1. FROZEN FALSIFIER (pre-registered 2026-06-14)
- **BLADE.** 빈도의존(희소이점) 선택도 순수선택처럼 단일형으로 붕괴한다.

## 2. 측정 결과 (REAL sim · discovery_batch_01.py::D15)
다양성(엔트로피) 빈도의존 1.10 vs 순수선택 0.74. 희소이점이 다형성 유지.
