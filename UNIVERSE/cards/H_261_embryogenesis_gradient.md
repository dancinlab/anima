...
- **hexa_only**: `UNIVERSE/state/h261_embryogenesis_gradient_2026_05_25/run_h261.hexa`
...
- **run cmd (verbatim, 2회 실행)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h261_embryogenesis_gradient_2026_05_25/run_h261.hexa`
...
- **state**: `UNIVERSE/state/h261_embryogenesis_gradient_2026_05_25/{run_h261.hexa,
  result.json, det_ref.txt}`.
...
================================================================
ledger -> UNIVERSE/state/h261_embryogenesis_gradient_2026_05_25/result.json
```
