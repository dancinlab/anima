...
- **run cmd (verbatim — harness)**:
  `HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h269_multiseed_2026_05_25/run_h269.hexa`
...
- **state**: `UNIVERSE/state/h269_multiseed_2026_05_25/{run_h269.hexa,
...
================================================================
ledger -> UNIVERSE/state/h269_multiseed_2026_05_25/result.json
```
