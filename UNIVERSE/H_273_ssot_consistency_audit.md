...
UNIVERSE 의 **SSOT 가 3-surface 로 분산** 되어 있다 — (a) `README.md` 의 가설 인덱스
...
| axis | levels |
|------|--------|
| **axis1: README surface** | `UNIVERSE/README.md` 가설 인덱스 표 (행 `^\| \[H_[0-9]+\]`, lib/ 행 자동 제외) |
| **axis2: disk surface** | `ls UNIVERSE/H_*.md` → basename → H_NNN (sort -V) |
...
- **smoke**: `UNIVERSE/state/h273_ssot_audit_2026_05_25/run_h273.hexa`
...
source: UNIVERSE/README.md 가설 인덱스 표 + UNIVERSE/H_*.md 파일 집합
...
**State output**: `UNIVERSE/state/h273_ssot_audit_2026_05_25/result.json`
