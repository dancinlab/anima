...
- **hexa_only**: `UNIVERSE/state/h262_quorum_sensing_2026_05_25/run_h262.hexa`
...
- **run cmd (verbatim — pool host)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h262_quorum_sensing_2026_05_25/run_h262.hexa`
...
- **state**: `UNIVERSE/state/h262_quorum_sensing_2026_05_25/{run_h262.hexa,
  result.json, det_fingerprint.txt}`.
...
================================================================
ledger -> UNIVERSE/state/h262_quorum_sensing_2026_05_25/result.json
```
