...
```
hexa parse UNIVERSE/state/h224_holism_whole_vs_sum_2026_05_24/run_h224.hexa
HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h224_holism_whole_vs_sum_2026_05_24/run_h224.hexa
```
...
================================================================
  result.json written → UNIVERSE/state/h224_holism_whole_vs_sum_2026_05_24/result.json
...
**State output**: `UNIVERSE/state/h224_holism_whole_vs_sum_2026_05_24/result.json`
(deterministic, sha256 reproducible across re-runs)
**Script**: `UNIVERSE/state/h224_holism_whole_vs_sum_2026_05_24/run_h224.hexa`
