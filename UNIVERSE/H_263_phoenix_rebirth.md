...
- **deterministic**: `__HEXA_FARR_GAUSS_SEED__=42` (RFC 033 gaussian) + 결정론적
  ...
  보장). 별도 RNG 부재.
- **hexa_only**: `UNIVERSE/state/h263_phoenix_rebirth_2026_05_25/run_h263.hexa`
...
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h263_phoenix_rebirth_2026_05_25/run_h263.hexa`
...
- **state**: `UNIVERSE/state/h263_phoenix_rebirth_2026_05_25/{run_h263.hexa,
  result.json}`.
...
================================================================
ledger -> .../UNIVERSE/state/h263_phoenix_rebirth_2026_05_25/result.json
```
