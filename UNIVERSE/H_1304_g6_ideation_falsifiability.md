---
id: H_1304
slug: 1304_g6_ideation_falsifiability
...
verdict_dir: .verdicts/1304_g6_ideation_falsifiability/
terminal_verdict: .verdicts/1304_g6_ideation_falsifiability/result.txt
date: 2026-06-16
---

# H_1304 — G6 IDEATION ★ depth-floor: falsifiability detector + composition-routed ideation
...
`UNIVERSE/h1304_g6_ideation_falsifiability.py` — reuses `gauge_lib.py` VERBATIM for decode
...
- probe: `UNIVERSE/h1304_g6_ideation_falsifiability.py`
- verdict: `.verdicts/1304_g6_ideation_falsifiability/{FREEZE.txt, result.txt, result.json}`
- claim: `CLAIMS.tape` @C h1304_g6_ideation_falsifiability
