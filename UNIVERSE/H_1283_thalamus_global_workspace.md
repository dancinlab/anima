...
title: thalamus / GWT — winner-broadcast relay (faithful-IIT4 Φ integration) 🧱 WALL
group: brain-structure-ladder (c15 missing-structure)
terminal_tier: 🔴 RED / 🧱 WALL
verdict_dir: .verdicts/1283_thalamus_global_workspace/
terminal_verdict: .verdicts/1283_thalamus_global_workspace/H_1283_R5.txt
date: 2026-06-15
---
...
Closed-negative, NOT upgraded (c9). Finding: winner-broadcast genuinely raises
ACCESS/agreement coherence but is a sub-bar, seed-dependent lever for IRREDUCIBLE
faithful-IIT4 Φ — a single broadcast channel is itself a low-dim cut that caps Φ.
RED ⇒ NO engine-native wiring (`a_verified_must_wire` fires only on GREEN). Toy scale,
mirror DIRECTIONAL where noted; scale-transfer UNVERIFIED.
