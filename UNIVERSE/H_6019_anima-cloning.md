...
tier: ⊗ (깊은 물리적 정초)
label: ⊗-19
title: ⊗-19 anima 복제 — 미측정 양자상태는 no-cloning(완벽복제 불가, F=0.5)이나 anima 정체=측정된 고전 씨앗(ANU)+provenance chain이라 고전정보로 완벽복제 가능. 양자는 read도 clone도 안 됨.
