#!/usr/bin/env python3
"""NOBEL_03 — Peres–Mermin magic square (rows +I, ∏cols -1). real QM. p7 $0."""
import numpy as np
...
print("NOBEL_03 Peres-Mermin: rows=+I",rows_ok,"∏cols=",int(np.prod(csign)),"contradiction →",("🟢" if contr else "🔴"))
