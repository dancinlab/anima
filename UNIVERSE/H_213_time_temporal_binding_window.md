...
**Run**: 2026-05-23, mac-local, `HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h213_temporal_binding_2026_05_23/run_h213.hexa`, $0 cost, deterministic (re-run byte-identical).
