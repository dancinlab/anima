...
- **hexa_only**: `UNIVERSE/state/h265_trained_vs_bare_ca_phi_2026_05_25/run_h265.hexa`.
...
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h265_trained_vs_bare_ca_phi_2026_05_25/run_h265.hexa`
...
- **literature pointer**: Wolfram (1984) CA classes · Langton (1990) edge-of-chaos
  ...
  mapping 본 cycle 미수행).
- **state**: `UNIVERSE/state/h265_trained_vs_bare_ca_phi_2026_05_25/{run_h265.hexa,
  result.json}`.
...
================================================================
ledger -> UNIVERSE/state/h265_trained_vs_bare_ca_phi_2026_05_25/result.json
```
...
**State output**: `UNIVERSE/state/h265_trained_vs_bare_ca_phi_2026_05_25/result.json`
**Smoke**: `UNIVERSE/state/h265_trained_vs_bare_ca_phi_2026_05_25/run_h265.hexa` (hexa-only, LLM none)
