...
- [~] E×F — round 3 cross-link (SAVANT × HIVE-MIND):
...
- [ ] F1 — round 1 seed (5 H) · **round 2 재발사: H_609 (H_352 carry) · H_610 (H_353 carry) · H_611 (H_356 carry)**:
  - [ ] H_352 `collective-phi-super-additive` — round 1 monitor-hang verdict 유실 (PR 미생성 WIP skeleton 잔존) → **round 2 H_609 으로 재발사**
  - [ ] H_353 `pair-polarity-collective-phi` — pair polarity {attract/repel/bipolar} 별 Φ_collective 분기 (Hc_286 promote) / 反: polarity 무관 평탄 ⚠ round-1 monitor-hang 미보고, slug retired → H_610 (round 2 refire)
  ...
  - [ ] H_356 `hivemind-transfer-entropy-align` — Φ_collective ∥ cross-substrate TE (H_290 sister r=0.883) / 反: r<0.5 [round 1 Agent abort, round 2 H_611 로 재발사]
