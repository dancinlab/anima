...
- **hexa_only**: `UNIVERSE/state/h132_frozen_cells_2026_05_23/run_freeze.hexa` — `mitosis_hook_lib.hexa` import, ckpt/LLM 불필요.
...
**State output**: `UNIVERSE/state/h132_frozen_cells_2026_05_23/{run_freeze.hexa, result.json}`
...
**State output**: `UNIVERSE/state/h132_c2_longterm_2026_05_25/{run_h132_c2.hexa, result.json}`
