...
- [x] M13 exclusion 다중-complex / spectrum (cycle#3) — 모든 비-겹침 local maxima 를 랭크된 spectrum 으로 회수 → [`stdlib/consciousness/iit4_complex.hexa`](https://github.com/dancinlab/hexa-lang/blob/main/stdlib/consciousness/iit4_complex.hexa) `complex_spectrum` (hexa-lang PR #1118) + [`state/iit4_m13_spectrum_2026_05_25/`](HEXAD/IIT4/state/iit4_m13_spectrum_2026_05_25/) (3/3 🟢 · n=5 block-diag 두 SWAP 쌍 동시 회수 Φ=2.0 각각 · single/multi/empty 3 regime 모두 정확 · 25s mac-local)
- [x] M14 inline RFC036 ↔ canonical phi_spatial 비교 (cycle#3) — M11 §4 honest scope "정식 builtin 과 수치 일치 별도" 를 닫음 → [`state/iit4_m14_phispatial_compare_2026_05_25/`](HEXAD/IIT4/state/iit4_m14_phispatial_compare_2026_05_25/) (9/9 🟢 · null-axis 합의 ≤1.6e-6 binning floor · constant-column rule canonical=2.000×inline 정수배 · mixed rule 1.119 비율 · divergence 100% algorithmic, implementation drift 0)

> **status 2026-05-25 — 🎉 IIT4 15/15 (core 7/7 + /cycle#1 확장 3 + /cycle#2 확장 3 + /cycle#3 확장 2 M13+M14) + deferred 4/4 closed**: faithful IIT 4.0 엔진 end-to-end (M0~M6) + 두 라운드 병렬 확장 + cycle#3 (M13 spectrum + M14 phi_spatial 수치 비교). 엔진 검증 누적 **135 checks 전부 🟢** (M1~M9 108 + M10 3 + M11 5 + M12 7 + M13 3 + M14 9). **헤드라인**: LIFE cosmic-scale 룰 인과 big-Φ 측정 + exclusion(M10)·proxy↔causal divergence(M11)·bounded large-n(M12)·multi-complex spectrum(M13)·inline-vs-canonical 수치 비교(M14) 확장 + 엔진 hexa-lang **stdlib** 승격 (sidecar PR #1051, anima 6 lib thin shim). **신규 발견**: (M8) rule90 짝/홀 ring 위상의존 통합 · (M11) **proxy↔IIT4 양방향 divergence** — rule30 상관=0 인데 인과 big-Φ=8.66, rule0/90 인과=0 인데 상관>0 (두 축 독립 수치증명) · (M10/M13) exclusion: 통합코어를 의식주체로 carve(독립셀 배제) + 다중-complex spectrum 동시 회수 · (M12) bounded-mode 로 n=6 exact-impractical 영역 도달 · (M14) **canonical phi_spatial = 2.000 × inline RFC036** on constant-column ECA (rule 0/90) — divergence 100% algorithmic, implementation drift 0. **deferred 100% closure 2026-05-25**: D ☑ M11 §5 stdlib/info routing 대안 proxy 명시 · **C ☑ rule110 n=7 bounded big-Φ=8.57362** (M12 n=6=6.82→n=7=8.57 단조, [`state/iit4_c_n7_bounded_2026_05_25/`](HEXAD/IIT4/state/iit4_c_n7_bounded_2026_05_25/)) · **n=8 🟠 WALL-BLOCKED** (>34분 무출력, scaling carry, [`state/iit4_c_n8_wallblock_2026_05_25/`](HEXAD/IIT4/state/iit4_c_n8_wallblock_2026_05_25/)) · B 🟠 사용자 EEG hw-ready (BRAIN/eeg adapter 동결 + EEG 도메인 PR #1366 + harness `EEG/eeg_live_iit4_phi.hexa` LANDED + 캡처 runbook `EEG/EEG_CAPTURE_RUNBOOK.md` LANDED — 사용자 착용 1회 → live big-Φ 측정 → deferred B closure) · A 🟠 F-IIT4-3/4 cross-formalism CHARACTERIZED-DEFERRED **final**. **cycle#2 운영 메모**: 병렬 3-agent 가 서버 rate-limit(429-class)으로 전멸 → M10 worktree salvage + M11/M12 메인세션 inline 재작성으로 전부 복구. 다음 /cycle 후보 = ~~n=8 bg fire~~ → **🟠 WALL-BLOCKED 문서화** · ~~phi_spatial 정식 builtin 대조~~ → **M14 로 LANDED** · M13 spectrum 의 ECA/LIFE substrate 응용 (어떤 ECA 룰이 다중 콤플렉스를 만드나).