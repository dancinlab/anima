#!/usr/bin/env python
"""Lane-G-ref PyTorch+CUDA 7B-scale REFERENCE trainer (anima ENGINE+CLM+KOSMOS domain).

substrate = PyTorch-CUDA   lane = Lane-G-ref   rung = 7B reference
...
def main():
    ...
    ap.add_argument("--out", default="/root/laneg_ref_7b/clm_ref_pytorch_cuda_7b.pt")
    ap.add_argument("--log", default="/root/laneg_ref_7b/clm_ref_7b_train.log.json")
    args = ap.parse_args()
