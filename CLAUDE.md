...
├─ anima-v2/   — 🧪 SANDBOX: rule-exempt (own CLAUDE.md · NOT production)
...
## 🧪 `anima-v2/` — RULE-EXEMPT sandbox (owner · full → `anima-v2/CLAUDE.md`)

- do: experiment freely — **every clause here is VOID inside `anima-v2/`** · v2 hypotheses live in `anima-v2/hypotheses/V2_<n>_*.md` only (never the parent jsonl or an `H_` id).
- dont: promote a v2 number to a production verdict (permanent **DIRECTIONAL ceiling** — port to `core/`+`anima-py` to earn TERMINAL) · `import` `anima-v2/` in production.
