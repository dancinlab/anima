...
- **`a7b_pass`** — anima 7B is complete only when ONE ckpt passes the frozen G0–G4 gates (SSOT = ARCHITECTURE.json 7B-gates node, absorbed from the retired 7B_PASS_CONDITIONS.md); never move a threshold.
