...
def evaluate_usage():
    ...
    print("  anima evaluate --earned <corpus.tsv> [--out <f.json>] [--min-occ 100] [--k-perm 1000] [--seeds a,b,c] [--null parametric|shuffle]")
...
_KNOWN_FLAGS = frozenset((
    ...
    "--help", "--ground-probe", "--interaction-lift", "--k-perm", "--kosmos", "--min-occ", "--null",
