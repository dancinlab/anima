...
def evaluate_usage():
    ...
    print("      (held-out XBIND recombination D-acc · corpus×task-class measure-swap · card H_9266)")
    print("")
...
def xbind_run(argv):
    ...
    (G1 reopen lane a · card H_9266). Engine-native numpy core/decode.py only
...
def main(argv):
    ...
    # --xbind <manifest.json>: held-out XBIND recombination (G1 reopen lane a · card H_9266).
