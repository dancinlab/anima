...
def anima_usage():
    ...
    print("        [--workspace-production DIR]            opt-in signed evidence ledger + proof/telemetry persistence")
    print("        [--workspace-trust-registry JSON]       source key env refs + preregistered claim/experiment/context map")
    print("        [--workspace-target-inference associational|causal]  causal mode requires randomized intervention evidence")
