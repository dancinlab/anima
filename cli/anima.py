...
def anima_usage():
    ...
    print("  anima-py corpus <ground|ground_lie> --atoms gt_atoms.json --out F [--reps N] [--replay N]")
    ...
    print("  corpus   : procedural training-corpus generator (derivtrace|flat|ground|ground_lie) — the")
...
# ══════════════════════════════════════════════════════════════════════════════
#
# `anima corpus <derivtrace|flat|ground|ground_lie> --out F ...`
...
def anima_corpus_mode(argv):
    ...
    fwd = argv[1:]
    print("=== anima corpus → cli/corpus.py (procedural training-corpus builder · derivtrace|flat|ground|ground_lie) ===")
