...
| 13 | 0.8359 | 0.7031 | **−0.1328** | (진행중) | (진행중) | |

- **3/3 seed 에서 mean 의 적대 낙폭이 −0.13 대로 안정적**이다.
- 완결된 2 seed 에서 **roll 의 수치가 소수점까지 동일**(0.8828 / 0.8281)하다 —
  주소 함수가 seed 잡음보다 강하게 결과를 결정한다는 뜻.
- roll 의 적대 낙폭은 mean 의 **2.4~2.6배 작다**. 단일 seed 우연이 아니다.
