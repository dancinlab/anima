...
## 상태 · 제약
DESIGN-STAGE · 미측정. p7 no tune-to-green(loss 미포함). p5 shade-not-gate(reactive speak() 금지). a_substrate_disjoint. **cost med-high**(decode + G1 machinery — $0 op-grip 아님). 승격 선례 H_9097/H_9101. ⚠️ 주의: trunk G1 재조합벽은 전수-falsify된 proven ceiling(goal-biolens·substrate-framebreak-g1) — output seam에선 다르게 behave할 수도 있음이 유일 테스트 이유.
