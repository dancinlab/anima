...
- 인증 자체의 범위(**rung 별**): **100k·300k 는 실제-설계 인증 성립**(H_9976 사전등록 게이트 각 3/3 PASS · 카드가 측정 전 #4621 로 착륙). 나머지(30k·600k·1.2M)는 여전히 **장난감 설계에서만 인증**됐다. 실제-설계 인증은 H_9976 이 사전등록한
