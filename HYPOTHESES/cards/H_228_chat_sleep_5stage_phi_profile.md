...
- **smoke**: `UNIVERSE/state/h228_chat_sleep_5stage_2026_05_24/run_h228.hexa`
...
- **run cmd (verbatim)**:
  `HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h228_chat_sleep_5stage_2026_05_24/run_h228.hexa`
