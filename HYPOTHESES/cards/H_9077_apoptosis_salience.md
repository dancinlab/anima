# H_9077 (D4) — apoptosis-근접 salience: MITOSIS 밀도의존 죽음-근접이 urgency 를 변조한다 (설계법칙 SATURATED)
...
`core/apoptosis_salience_smoke.hexa` → **9 PASS / 0 FAIL** (verbatim = state/verdicts/apoptosis_salience/H_9077.txt)
