...
2. 신규 각도면 cheap numpy DIRECTIONAL reachability probe → `state/6104_gen_ag_constraint_intersection/`.
3. DIRECTIONAL GREEN 이면 engine-native 재측정(.hexa via core/) 사다리 진입(a_verified_must_wire).

## artifacts

- `cards/H_6104_gen_ag_constraint_intersection.md` (this card)
- `state/6104_gen_ag_constraint_intersection/` (probe 발사 시 생성)
