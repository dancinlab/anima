# H_1837 — TENSION-MOUTH ITERATED (deep-equilibrium temporal escape)
...
**artifacts:** `state/1837_tension_mouth_iterated/{tension_mouth_iterated_probe.py, results.md, H_1837_result.json, run.log}` · `state/verdicts/1837_tension_mouth_iterated/H_1837_FREEZE.txt`
...
## frozen bar (pre-registered `H_1837_FREEZE.txt`, p7, c9, tune-to-green 금지)
