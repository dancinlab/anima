...
> **tier:** 📋 **PRE-REGISTERED / IDEATION** (fable 발산 설계, 미발사·측정 verdict 없음, DIRECTIONAL-pending) · **wired:** N/A
>
...
## 정직 스코프 (c9)
- 전부 **미발사 설계**(fable=opus-diverged [[workflow-model-fable-override-ignored]], 측정 0=verdict 없음). mini numpy DIRECTIONAL 시작→engine-native `anima evaluate --py` 재측정으로만 terminal(하드게이트 1).
