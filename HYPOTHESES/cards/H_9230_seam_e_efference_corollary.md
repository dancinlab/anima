...
## 상태 · 제약
DESIGN-STAGE · 미측정. p7 no tune-to-green(loss 미포함). p5 shade-not-gate(reactive speak() 금지). a_substrate_disjoint. **cost medium**(logit-proxy로 예측 output 필요 — $0 아님). 승격 선례 H_9097/H_9101.
