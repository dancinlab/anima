...
**status:** 🔵 PRE-REG → S0/S1 배선 → S1 POSITIVE → C2 4/4 VALID → 🟢 toy 래더 완결(scratch·growth·BOLT) → **⚪/🔴 S2 303M: toy DIRECTIONAL 이 303M 로 미전이 (owner go · pool summer 3-arm)** · G1 미종결(OPEN) · not-terminal(toy·합성·DIRECTIONAL) · wired: CLMS lane 추론+학습 배선완료
