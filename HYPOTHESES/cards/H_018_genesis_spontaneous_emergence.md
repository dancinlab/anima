...
- **hexa_only**: `UNIVERSE/state/h018_genesis_2026_05_23/run_genesis.hexa`
...
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 hexa run UNIVERSE/state/h018_genesis_2026_05_23/run_genesis.hexa`
