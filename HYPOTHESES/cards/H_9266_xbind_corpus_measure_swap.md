# H_9266 — XBIND: corpus×task-class 교체가 G1 재조합 벽을 여는가 (earned-terminal exit · engine-native 303M)

**tier**: 🔬 REGISTERED · PREREG 동결(bar §4 verbatim FREEZE) · 오너 G1-reopen rent=spend go · A100 3-run (Fable 설계)
