...
- **hexa_only**: `UNIVERSE/state/h267_phi_divergence_2026_05_25/run_h267.hexa`.
...
- **run cmd (verbatim)**:
  `__HEXA_FARR_GAUSS_SEED__=42 HEXA_MEM_UNLIMITED=1 hexa run UNIVERSE/state/h267_phi_divergence_2026_05_25/run_h267.hexa`
...
- **state**: `UNIVERSE/state/h267_phi_divergence_2026_05_25/{run_h267.hexa,
  result.json}`.
...
**State output**: `UNIVERSE/state/h267_phi_divergence_2026_05_25/result.json`
**Smoke**: `UNIVERSE/state/h267_phi_divergence_2026_05_25/run_h267.hexa` (hexa-only, LLM none)
