...
- Loaded by: `PeftModel.from_pretrained(atp_base, "dancinlab/vlm-anima-voice-paradigm-stage1-step-10k")`
...
@misc{anima_vlm_stage1_step10k_2026,
  ...
  year   = {2026},
  url    = {https://huggingface.co/dancinlab/vlm-anima-voice-paradigm-stage1-step-10k}
}
```
