...
PURPOSE
    ...
    Cotrained ckpt (`ckpt_v5mitosis_cotrain_v2_cotrain.pt`) re-measure FAILed F-PERSONA-4
    ...
    Investigation produces JSON `persona_4_root_cause_results_v2.json` + verdict.
...
OUT_JSON = HERE / "persona_4_root_cause_results_v2.json"
