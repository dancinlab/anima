...
STATE_DIR='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04'
RESULTS_DIR='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/results'
CORPUS_DIR='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/corpus'
SLICE_A_LOCAL='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/corpus/slice_A_anima_30k.jsonl'
...
POD_INFO='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/pod_info.json'
VERDICT='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/verdict.json'
RUN_LOG='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/run.log'
HEARTBEAT='/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/heartbeat.txt'
...
POD_NAME='anima-p9-pathA-retrain-v2-RETRY-2026-05-04'
...
if [ $BOOT_RC -ne 0 ]; then
    ...
    jq -n --arg ts "$(date -u +%FT%TZ)" --arg reason "pod_boot_failed" '{cycle:"p9_path_a_retrain_v2_retry_2026_05_04",ts_utc:$ts,verdict:"FAIL",reason:$reason}' > "$VERDICT"
    exit 3
fi
...
$SCP "/Users/ghost/core/anima/state/p9_path_a_retrain_v2_retry_2026_05_04/run_h100.bash" "root@$SSH_HOST:/workspace/p9_retrain_v2/run_h100.bash" 2>&1 | tail -1
...
jq -n \
    --arg cycle "p9_path_a_retrain_v2_retry_2026_05_04" \
    --arg ts "$(date -u +%FT%TZ)" \
    ...
    '{
        ...
        predecessor_failed: "79861cda (BG-α corpus_mix DatasetNotFoundError cais/mmlu — pod mp8twau8buyir6 killed at $0.10 in 2min)",
        fix_applied: "explicit token= propagation, retry-with-backoff (4 attempts, 8s base exp delay), per-slice fallback chain (cais/mmlu→lighteval/mmlu, mandarjoshi/trivia_qa→trivia_qa, Salesforce/wikitext→wikitext)",
        ...
        honest_c3: [
            "RETRY cycle: predecessor BG-α (79861cda) failed at slice_B1_mmlu with DatasetNotFoundError on cais/mmlu; root cause was almost-certainly transient HF Hub network (cais/mmlu IS public+ungated per /api/datasets metadata probe pre-retry) but the fix path (retry+fallback+token) hardens against both transient AND any future HF dataset-id drift; this means a corpus_mix SUCCESS in this retry cannot distinguish whether (a) the original was transient and any retry would have worked or (b) the explicit-token / fallback path was load-bearing — record both in source counts metadata.",
