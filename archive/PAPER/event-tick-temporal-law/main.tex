...
All nine rungs build on one harness, \texttt{HYPOTHESES/h1163\_tick\_decode\_metric.py}
...
\texttt{HYPOTHESES/h1163\_tick\_decode\_metric.py}. Figures regenerate from the
