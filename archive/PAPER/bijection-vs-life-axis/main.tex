...
(\texttt{HYPOTHESES/H\_312} through \texttt{H\_333}) on the
...
\item All twenty-six measurements are published as a
      ...
      (\texttt{HYPOTHESES/state/h312...h333/result.json}) under
...
branch. Excerpt (\texttt{HYPOTHESES/state/h328\_*/result.json}):
...
data from \texttt{HYPOTHESES/state/h328\_*} (n$=$4) and
...
\texttt{HYPOTHESES/state/h312\_*} through
\texttt{h346\_*} on
\url{https://github.com/dancinlab/anima/tree/main/HYPOTHESES/state}.
...
\texttt{cat HYPOTHESES/state/<slug>/run.hexa | pool on ubu-2 'cat
