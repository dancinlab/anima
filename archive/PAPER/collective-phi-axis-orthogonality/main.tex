...
(\texttt{HYPOTHESES/H\_354,355,609--611,617--619}) that probe whether
...
transcripts) under
\texttt{HYPOTHESES/state/h354\_*}, \texttt{h355\_*},
...
cd anima
hexa run HYPOTHESES/state/h355_*/run_h355.hexa
diff HYPOTHESES/state/h355_*/run.log <(hexa run ...)
\end{lstlisting}
