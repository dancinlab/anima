...
> `PI5-AKIDA.json`(local-only), 가설은 `HYPOTHESES/cards/H_672_*` 가 SSOT.
...
- 가설/verdict: `HYPOTHESES/cards/H_672_akida_spontaneous_firing.md` (Group A) · H_673~H_678 (B~G, HW-runnable now, HW-confirm 미시행)
