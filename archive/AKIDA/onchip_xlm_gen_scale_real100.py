...
count, recs = read_limen(os.path.join(ROOT, "corpus_real100", "parallel.limen"))
...
RESULTS = {"substrate": "AKIDA (on-chip 1-bit Hebbian)", "rung": "SINGLE-STEP open-vocab GENERATION ANCHOR-COUNT scale ladder",
           ...
           "ladder_n_concepts": NCONCEPTS_LADDER, "corpus": "corpus_real100 500 anchors / 100 REAL aligned concepts (50 FLORES + 40 authored aphorisms + 10 new authored) x 5 langs",
           "rungs": []}
