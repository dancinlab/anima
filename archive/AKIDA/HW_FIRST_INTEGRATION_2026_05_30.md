...
| F (this) | 이 SSOT · `HYPOTHESES/cards/H_679` · `H_680` · `AKIDA.log.md` | 문서 SSOT + 감사 H 2건 |
...
- 감사 H: `HYPOTHESES/cards/H_679_plasticity_hw_first.md` · `HYPOTHESES/cards/H_680_decoder_hw_first.md`
