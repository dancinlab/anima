...
RESULTS = {"substrate": "HYBRID(on-chip AKD1000 encoder ⊕ off-chip host-CPU decode head)",
           ...
           "corpus": "corpus_real100 500 anchors / 100 REAL aligned concepts (50 FLORES + 40 authored + 10 new) x 5 langs; BRANCHING operator REPLACES the deterministic chain",
