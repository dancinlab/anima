---
id: Hc_733
slug: az-e8-adversarial-fact-check-loop-reduces-hallucination
title: [E8] Adversarial fact-check loop reduces hallucination
...
notes: "A-Z domain E (web-learning), sub-H E8. parent: Hc_034"
rescue_status: rescued
rescued_from: 97113c244
rescued_at: 2026-05-12
---
## Hypothesis
E8] Adversarial fact-check loop reduces hallucination

## Source Content (rescued from 97113c244)
Source: `docs/hypotheses/A-Z-overview.md` line 98 (pre-move revision `97113c244`).

- **E8** Adversarial fact-check
