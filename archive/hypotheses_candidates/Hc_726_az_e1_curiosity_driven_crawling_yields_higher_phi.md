---
id: Hc_726
slug: az-e1-curiosity-driven-crawling-yields-higher-phi
title: [E1] Curiosity-driven crawling yields higher Phi than random crawling
...
notes: "A-Z domain E (web-learning), sub-H E1. parent: Hc_034"
rescue_status: rescued
rescued_from: 97113c244
rescued_at: 2026-05-12
---
## Hypothesis
E1] Curiosity-driven crawling yields higher Phi than random crawling

## Source Content (rescued from 97113c244)
Source: `docs/hypotheses/A-Z-overview.md` line 91 (pre-move revision `97113c244`).

- **E1** Curiosity crawling
