...
- H_xxx = HYPOTHESES/cards/H_841_temporal_timeshift_phi.md
...
- H_xxx = HYPOTHESES/cards/H_842_temporal_time_embed_phi.md
...
- H_843 = HYPOTHESES/cards/H_843_temporal_ultradian_phi.md (3-신호: file 0 · grep 0 · ls-tree 0)
