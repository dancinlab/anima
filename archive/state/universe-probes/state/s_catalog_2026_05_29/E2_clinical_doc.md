...
- sibling: E2 cluster (S32·S27·S34) ↔ 다른 catalog 클러스터 (E1/E3 등) — `HYPOTHESES/state/s_catalog_2026_05_29/` 하위 형제 .md
- SSOT link: `HYPOTHESES/CANDIDATES.md` (S-축 가설 카탈로그) — 본 verdict 반영 필요
