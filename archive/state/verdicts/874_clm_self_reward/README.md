# .verdicts/874_clm_self_reward/ — H_874 backing dir (hexa-native-guard)
...
- Hypothesis doc: `HYPOTHESES/cards/H_874_clm_self_reward.md`
...
- Result JSON (post-fire): `.verdicts/clm-self-reward/clm_self_reward_mid_AB.json`

W2 · deterministic:false · byte-match ✗ (Q-TRUST A reuse). External LLM 0.
