...
- LZ76 reuse: `CORE/DECODER/d1_lz76_collapse_proxy.hexa` (`lz76`/`lz_norm`/`ids_to_bits` verbatim · g61) ← `HYPOTHESES/state/h288.../run_h288.hexa`
- H_493 출처: `CORE/DECODER/UNIVERSE_SYNTHESIS.md` §후보 β · `HYPOTHESES/cards/H_314_symbiogenesis_merge_alpha_sweep.md` (🔵)
