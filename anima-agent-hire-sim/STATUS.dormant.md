...
## Why
- anima-agent extracted to standalone repo (`need-singularity/anima-agent` v1.0.0, 2026-05-04).
...
2. Migrate to a sister repo (`need-singularity/anima-agent-hire-sim`) — clean cross-repo dependency, follows the same extraction pattern as channels/providers/plugins/skills sister repos.
