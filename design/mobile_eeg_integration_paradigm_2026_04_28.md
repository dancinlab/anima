...
Frozen 2026-04-28 · raw#9/10/12/37/65/71/82/91/own5
...
required, separate license). 본 통합은 **Muse 우선**; Emotiv 는 stub-only (raw#10 honest C3).
...
## 6. Falsifiers (raw#71 ≥5)

- **F1** 사용자 Muse/Emotiv hardware 미보유 (raw#10 honest C3 — 별도 구입 필요)
...
- raw#9 pure-hexa tool, no python in critical path
- raw#10 deterministic FNV synth seed
- raw#12 frozen criteria above (common-subset r>0.5, LZ76 ≤0.1)
- raw#37 SSOT ledger path
- raw#65 idempotent (sha-style session_id)
- raw#71 5+ falsifiers
- raw#82 darwin-native
- raw#91 honest C3: hardware not user-owned, integration is design+selftest only
