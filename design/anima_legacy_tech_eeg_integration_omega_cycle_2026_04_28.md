...
**Roadmap policy:** raw#10 honest C3, raw#12 frozen criteria preserved, raw 91 honest neural-LLM separation, own 5 completeness-first

---

## 0. Honest scope (raw#10 / raw 91)
...
- **Falsifiers (3+):**
  ...
  3. F3: re-run with eyes-OPEN segment → if LZ jumps ≥ 0.15, drowsy/alpha-dominance confound CONFIRMED → frozen criterion preserved (raw#12), measurement context corrected
...
- **Schartner 0.65 threshold absoluteness:** today's b=0.479 (filtered) vs 0.395 (raw EMI segment) does NOT necessarily falsify subject's consciousness; eyes-closed alpha-dominance is a known LZ-suppressor (Schartner 2017 controls were eyes-OPEN resting). **raw#12 frozen criterion preserved; measurement-context falsifier (eyes-open rerun) is the next step, NOT criterion retirement.**
