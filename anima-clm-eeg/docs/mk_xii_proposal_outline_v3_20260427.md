...
- `<repo-root>/anima-clm-eeg/docs/mk_xii_proposal_outline_20260426.md` — **v1 frozen** (sha256 `d9111398…`)
- `<repo-root>/anima-clm-eeg/docs/mk_xii_proposal_outline_v2_20260426.md` — **v2 frozen** (sha256 `f46d3c67…`)
- `<repo-root>/anima-clm-eeg/docs/mk_xii_proposal_v2_section_4_chain_integration_v2_1_spec.md` — **v2.1 prep §4 frozen** (sha256 `cb0f39ab…`, this v3 §4 actual lock 베이스)
- `<repo-root>/anima-clm-eeg/docs/dali_sli_v3_input_mode_landing.md` — **#223 DALI+SLI v3 input mode 2/3 coverage landing** (tool sha `4c8b210a…`, state content sha `48cd8bee…`)
- `<repo-root>/anima-clm-eeg/docs/s7_n11_extension_landing.md` — **#220 S7 N=11 PASS_TIGHT 4096-perm landing** (state sha `e48560ff…`, p=0.0188)
- `<repo-root>/anima-clm-eeg/docs/cmt_3mode_n9_extension_landing.md` — **#222.cmt CMT N=11 input-mode 보강 R²+24.7%** (state sha `396c5af8…`, r=+0.564)
- `<repo-root>/anima-clm-eeg/docs/mk_xii_substrate_witness_ledger_discovery_landing.md` — **#226 substrate ledger v2 9/9 + LIVE 0/11 floor discovery** (sha256 `6f67a8ae…`, fp=661882989)
- `<repo-root>/anima-physics/tool/mk_xii_substrate_witness_ledger_aggregator_v2.hexa` — ledger v2 aggregator (sha `0fff9a98…`, raw#9 strict 32KB, 5 ledger gates G1-G5)
- `<repo-root>/anima-physics/docs/mk_xii_substrate_witness_ledger_v2_landing.md` — ledger v2 landing (sha `da241895…`, 11-row matrix)
- `<repo-root>/state/v10_anima_physics_cloud_facade/integration_ledger/witness_ledger_v2.json` — ledger v2 body (sha `df545c5e…`)
- `<repo-root>/anima-clm-eeg/docs/mk_xii_integration_6gate_cluster_summary.md` — 6-gate cluster `min`-rule weakest=G10 0.70 (carry v2)
- `<repo-root>/anima-clm-eeg/docs/dali_sli_v2_redesign_landing.md` — #207 v2 redesign 1/3 coverage (this v3 superseded)
- `<repo-root>/anima-clm-eeg/docs/dali_sli_weighted_vote_landing.md` — #183 weighted-vote v1 NOT_ELIGIBLE (carry)
- `<repo-root>/anima-clm-eeg/docs/mk_xii_d_day_simulated_landing.md` — #204 D-day simulated dry-run
...
- `<repo-root>/anima-eeg/{calibrate,realtime,collect,experiment,eeg_recorder,closed_loop,dual_stream}.hexa` — Phase 4 wrapper 7/9 (#216-#228, dual_stream 본 cycle 후 7/9)
- `<repo-root>/anima-clm-eeg/state/markers/{dali_sli_v3_input_mode,s7_n11_extension,mk_xii_substrate_witness_ledger_discovery}_complete.marker` — sister markers (this v3 cycle + predecessors)
- `<repo-root>/anima-clm-eeg/state/markers/mk_xii_proposal_v3_complete.marker` — **본 v3 marker** (silent-land 방지)
